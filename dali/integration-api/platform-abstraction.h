...
public:
   ...
   * @result             true if the file is loaded.
   */
  virtual bool LoadShaderBinFile( const std::string& filename, Dali::Vector< unsigned char >& buffer ) const = 0;
   ...
   */
  virtual bool SaveShaderBinFile( const std::string& filename, const unsigned char * buffer, unsigned int numBytes ) const = 0;
