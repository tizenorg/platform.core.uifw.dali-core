...
int UtcDaliTextureUpload03(void)
{
  ...
  dataMipmap1.Resize( width*height*32);
  texture.Upload( data, 0u, 1u, 0u, 0u, widthMipmap1, heightMipmap1 );
  application.SendNotification();
  application.Render();
...
int UtcDaliTextureUpload04(void)
{
  ...
  Vector<unsigned char> dataMipmap1;
  dataMipmap1.Resize( width*height*32);
  texture.Upload( data, CubeMap::NEGATIVE_X, 1u, 0u, 0u, widthMipmap1, heightMipmap1 );
  application.SendNotification();
  application.Render();
