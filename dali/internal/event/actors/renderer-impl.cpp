...
void Renderer::SetDepthIndex( int depthIndex )
{
  ...
  SceneGraph::PropertyMessage<int>::Send( updateManager, mSceneObject, &mSceneObject->mDepthIndex, &SceneGraph::AnimatableProperty<int>::Bake, depthIndex );
}
...
{
  RENDERER_IMPL.SetSceneGraphProperty( this, index, entry, value );
