...
public:
   ...
   */
  virtual void DispatchUpdateTexture( ResourceId id, Integration::Bitmap* bitmap, std::size_t xOffset, std::size_t yOffset ) = 0;
 ...
 /**
  ...
  /**
   * Dispatch a message to clear the texture.
   * @param[in] id Resource id of the texture.
   * @param[in] color The color used to clear the texture.
   */
  virtual void DispatchClear( ResourceId id, const Vector4& color ) = 0;
