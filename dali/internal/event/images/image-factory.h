...
public:
  ...
  /**
   * Clear the an atlas, this will also clear all the resource cache related to this atlas.
   * @param[in] resourceId The atlas resource id.
   * @param[in] color Clear color
   */
  void ClearAtlas( ResourceId resourceId, const Vector4& color );
...
private:
  ...
  ImageFactoryCache::AtlasClearColorList mAtlasClearColors; ///< List of atlas clear color
};
