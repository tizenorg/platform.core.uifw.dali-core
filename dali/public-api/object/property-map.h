...
public:
  ...
  /**
   * DEPRECATED_1_1.39. Retrieve the value with key instead of position.
   *
  ...
  /**
   * DEPRECATED_1_1.39 Position based retrieval is no longer supported after extending the key type to be Index as well as String
   *
