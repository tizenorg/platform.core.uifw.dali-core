 ...
 * @SINCE_1_1.36
 */
struct DALI_IMPORT_API TouchData
{
...
public: // Not intended for application developers
  ...
  /**
   * @brief Retrieves a reference to the internal touch data object
   *
   * @return A reference to the internal touch data object
   */
  Internal::TouchData& GetObject();

  /**
   * @brief Retrieves a const reference to the internal touch data object
   *
   * @return A const reference to the internal touch data object
   */
  const Internal::TouchData& GetObject() const;
