#ifndef DALI_INTERNAL_UNIFORM_CACHE_H
#define DALI_INTERNAL_UNIFORM_CACHE_H
...
/**
 * This class maps uniform names to unique indices
 */
class UniformCache
{
public:
...
private: // Data
  ...
  struct UniformEntry
  {
    UniformEntry( const std::string& name )
    : uniformName( name ),
      nameHash( 0 )
    { }
...
#endif // DALI_INTERNAL_UNIFORM_CACHE_H
