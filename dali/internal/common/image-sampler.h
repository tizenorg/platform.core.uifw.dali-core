...
namespace ImageSampler
{
  ...
  /**
   * @brief Create a bit pattern to represent and uninitialised bitfield.
   *
   * @return Return the uninitialised bitfield pattern.
   */
  unsigned int UninitialisedBitfield();

  /**
   * Determine if the minify component of the bitfield is initialized.
   *
   * @param[in] bitfield The packed sampler bitfield pattern.
   * @return Return if the minify component is initialized or not.
   */
  bool IsMinifyInitialized( unsigned int bitfield );

  /**
   * Determine if the magnify component of the bitfield is initialized.
   *
   * @param[in] bitfield The packed sampler bitfield pattern.
   * @return Return if the magnify component is initialized or not.
   */
  bool IsMagnifyInitialized( unsigned int bitfield );
   ...
   * @return Return the packed bitmap.
   */
