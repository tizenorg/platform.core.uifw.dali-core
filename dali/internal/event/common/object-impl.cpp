...
Property::Value Object::GetProperty(Property::Index index) const
{
  ...
  else if( mCustomProperties.Count() > 0 )
  {
    ...
    {
      BufferIndex bufferIndex( mEventThreadServices.GetEventBufferIndex() );
...
Property::Index Object::RegisterProperty( const std::string& name, const Property::Value& propertyValue)
{
  ...
  if( scenePropertyOwner )
  {
    ...
    InstallCustomPropertyMessage( mEventThreadServices, *scenePropertyOwner, newProperty.Release() ); // Message takes ownership
...
void Object::SetSceneGraphProperty( Property::Index index, const CustomProperty& entry, const Property::Value& value )
{
  switch ( entry.type )
  {
    case Property::BOOLEAN:
    {
      ...
      BakeMessage<bool>( mEventThreadServices, *property, value.Get<bool>() );
      break;
    }
    ...
    case Property::FLOAT:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<float>( mEventThreadServices, *property, value.Get<float>() );
      break;
    }
    ...
    case Property::INTEGER:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<int>( mEventThreadServices, *property, value.Get<int>() );
      break;
    }
    ...
    case Property::VECTOR2:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<Vector2>( mEventThreadServices, *property, value.Get<Vector2>() );
      break;
    }
    ...
    case Property::VECTOR3:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<Vector3>( mEventThreadServices, *property, value.Get<Vector3>() );
      break;
    }
    ...
    case Property::VECTOR4:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<Vector4>( mEventThreadServices, *property, value.Get<Vector4>() );
      break;
    }
    ...
    case Property::ROTATION:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<Quaternion>( mEventThreadServices, *property, value.Get<Quaternion>() );
      break;
    }
    ...
    case Property::MATRIX:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<Matrix>( mEventThreadServices, *property, value.Get<Matrix>() );
      break;
    }
    ...
    case Property::MATRIX3:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      BakeMessage<Matrix3>( mEventThreadServices, *property, value.Get<Matrix3>() );
      break;
    }
