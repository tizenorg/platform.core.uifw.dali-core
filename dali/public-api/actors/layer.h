...
public:
  ...
  enum Behavior
  {
     ...
     *
     * This mode is designed for UI controls. In this mode renderer ordering will be respect to tree level of each Actor.
     ...
     * Rendering order between siblings, such as D, E & F or B & C, is determined based on the depth index.
