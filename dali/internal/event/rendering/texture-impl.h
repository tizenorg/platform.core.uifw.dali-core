...
public:
   ...
   */
  static NewTexturePtr New(TextureType::Type type, Pixel::Format format, unsigned int width, unsigned int height, bool hasMipmaps );
...
private: // implementation
   ...
   * Constructor
   */
  NewTexture(TextureType::Type type, Pixel::Format format, unsigned int width, unsigned int height, bool hasMipmaps );
