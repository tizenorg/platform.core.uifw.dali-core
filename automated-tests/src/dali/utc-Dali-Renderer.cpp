...
int UtcDaliRendererSetGetGeometry(void)
{
  ...
  Property::Index fadeColorIndex1 = geometry1.RegisterProperty( "fade-color-1", Color::RED );
  geometry1.AddUniformMapping( fadeColorIndex1, std::string("uFadeColor") );

  Geometry geometry2 = CreateQuadGeometry();
  Property::Index fadeColorIndex2 = geometry2.RegisterProperty( "fade-color-2", Color::GREEN );
  geometry2.AddUniformMapping( fadeColorIndex2, std::string("uFadeColor") );
...
int UtcDaliRendererSetGetMaterial(void)
{
  ...
  Property::Index fadeColorIndex1 = material1.RegisterProperty( "fade-color-1", Color::RED );
  material1.AddUniformMapping( fadeColorIndex1, std::string("uFadeColor") );

  Material material2 = CreateMaterial(1.0f);
  Property::Index fadeColorIndex2 = material2.RegisterProperty( "fade-color-2", Color::GREEN );
  material2.AddUniformMapping( fadeColorIndex2, std::string("uFadeColor") );
