...
void NewAnimation( const Property::Map& map, Dali::Internal::AnimationData& outputAnimationData )
{
  ...
  Dali::Internal::AnimationData::AnimationDataElement* element = new Dali::Internal::AnimationData::AnimationDataElement();
