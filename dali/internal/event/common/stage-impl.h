...
public:
   ...
   */
  void EmitTouchedSignal( const TouchEvent& touch, const Dali::TouchData& touchHandle );
  ...
  /**
    ...
    */
  Dali::Stage::TouchSignalType& TouchEventSignal();
...
private:
  ...
  Dali::Stage::TouchSignalType                    mTouchEventSignal;
