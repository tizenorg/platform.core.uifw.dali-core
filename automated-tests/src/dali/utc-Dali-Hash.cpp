...
int UtcDaliHash(void)
{
  ...
  DALI_TEST_CHECK( Dali::CalculateHash( testString1 ) != Dali::Hash( testString2 )  );
  DALI_TEST_CHECK( Dali::CalculateHash( testString1, testString2 ) != Dali::Hash( testString2, testString1 )  );
