...
public:
  ...
  /**
   * @brief Struct to aid the passing of stencil parameters to the Renderer object.
   */
  struct StencilParameters
  {
    ...
    int stencilFunctionMask;                          ///< Local copy of the stencil function mask
    int stencilFunctionReference;                     ///< Local copy of the stencil function reference
    int stencilMask;                                  ///< Local copy of the stencil mask
    StencilFunction::Type stencilFunction:3;          ///< Local copy of the stencil function
    StencilOperation::Type stencilOperationOnFail:3;  ///< Local copy of the stencil operation for stencil test fail
    StencilOperation::Type stencilOperationOnZFail:3; ///< Local copy of the stencil operation for depth test fail
    StencilOperation::Type stencilOperationOnZPass:3; ///< Local copy of the stencil operation for depth test pass
    StencilMode::Type stencilMode:2;                  ///< Local copy of the stencil mode
  };
