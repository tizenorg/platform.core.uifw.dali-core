...
void RelayoutController::OnApplicationSceneCreated()
{
  ...
  Dali::Internal::SystemOverlay* systemOvelay = GetImplementation(stage).GetSystemOverlayInternal();
  if( systemOvelay )
  {
    Dali::Internal::Actor& systemOverlayInternalRoot = systemOvelay->GetDefaultRootActor();
