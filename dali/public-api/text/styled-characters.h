...
public:
  ...
  StyledCharacters( std::size_t firstCharacter, std::size_t numberOfCharacters, const TextStyle& style, TextStyle::Mask mask = TextStyle::ALL );
  ...
  void UpdateRange( std::size_t firstCharacter, std::size_t numberOfCharacters );
