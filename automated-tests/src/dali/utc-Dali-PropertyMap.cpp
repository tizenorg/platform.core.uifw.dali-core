...
{
  Property::Map map;
  DALI_TEST_EQUALS( (Property::Map::SizeType)0u, map.Count(), TEST_LOCATION );
  map.Insert( "foo", "bar");
  DALI_TEST_EQUALS( (Property::Map::SizeType)1u, map.Count(), TEST_LOCATION );
  ...
  DALI_TEST_EQUALS( (Property::Map::SizeType)2u, map.Count(), TEST_LOCATION );
  value = map.Find( "foo2" );
  DALI_TEST_CHECK( value );
