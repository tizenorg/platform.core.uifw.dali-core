...
void Renderer::OnStageConnect()
{
  ...
  if( !mRenderer)
  {
    ...
    mRenderer = Render::Renderer::New( dataProvider, mGeometry, mBlendBitmask, mBlendColor,
                                       static_cast< FaceCullingMode::Type >( mFaceCullingMode ),
                                       mPremultipledAlphaEnabled, mDepthWriteMode, mDepthTestMode, mDepthFunction,
                                       //todor
                                       mStencilMode, mStencilFunction, mStencilFunctionMask, mStencilFunctionReference,
