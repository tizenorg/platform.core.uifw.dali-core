...
Geometry& Geometry::operator=( Geometry& handle )
{
...
{
  return GetImplementation(*this).AddVertexBuffer( vertexBuffer );
}
...
{
  GetImplementation(*this).SetIndexBuffer( indexBuffer );
}
...
bool Geometry::GetRequiresDepthTesting()
{
