...
{
  ValidateBuffer();
  PixelBuffer* buffer = mBitmap->GetBuffer();
...
void BufferImage::ValidateBuffer()
{
...
void BufferImage::Connect()
{
  ...
  // Connected to stage, so make sure we have a bitmap and a ticket by calling ValidateBuffer()
  ValidateBuffer();
