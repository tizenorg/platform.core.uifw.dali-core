...
void Material::SetShader( Shader& shader )
{
  ...
  SceneGraph::Shader& sceneGraphShader = *shader.GetSceneShader();
...
void Material::AddSampler( Sampler& sampler )
{
  ...
  SceneGraph::Sampler& sceneGraphSampler = *sampler.GetSceneSampler();
...
void Material::RemoveSampler( std::size_t index )
{
  if( index < mSamplerConnectors.size() )
  {
    ...
    SceneGraph::Sampler& sceneGraphSampler = *iter->Get()->GetSceneSampler();
