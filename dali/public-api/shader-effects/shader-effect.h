...
public:
  ...
  enum GeometryHints
  {
    HINT_NONE           = 0x00,   ///< @DEPRECATED_1_0.47 no hints @SINCE_1_0.0
    HINT_GRID_X         = 0x01,   ///< @DEPRECATED_1_0.47 Geometry must be subdivided in X @SINCE_1_0.0
    HINT_GRID_Y         = 0x02,   ///< @DEPRECATED_1_0.47 Geometry must be subdivided in Y @SINCE_1_0.0
    HINT_GRID           = (HINT_GRID_X | HINT_GRID_Y),  ///< @DEPRECATED_1_0.47 @SINCE_1_0.0
    HINT_DEPTH_BUFFER   = 0x04,   ///< @DEPRECATED_1_0.47 Needs depth buffering turned on @SINCE_1_0.0
    HINT_BLENDING       = 0x08,   ///< @DEPRECATED_1_0.47 Notifies the actor to use blending even if it's fully opaque. Needs actor's blending set to BlendingMode::AUTO @SINCE_1_0.0
    HINT_DOESNT_MODIFY_GEOMETRY = 0x10 ///< @DEPRECATED_1_0.47 Notifies that the vertex shader will not change geometry (enables bounding box culling) @SINCE_1_0.0
  };
