...
void RenderMesh::SetMeshData(MeshData* meshData)
{
  mMeshData = meshData;
}

const MeshData& RenderMesh::GetMeshData( BufferIndex /*bufferIndex*/ ) const
{
...
void RenderMesh::MeshDataReplaced( BufferIndex bufferIndex, MeshData* meshData )
{
...
void RenderMesh::UploadVertexData( Context& context, BufferIndex renderBufferIndex )
{
...
bool RenderMesh::HasGeometry( BufferIndex bufferIndex ) const
{
