...
int UtcDaliQuaternionCtorAxisAngleVector3P(void)
{
  ...
  Quaternion q( M_PI/2.0f, Vector3( 1.0f, 2.0f, 3.0f ) );
...
int UtcDaliQuaternionCtorAxisAngleVector4P(void)
{
  TestApplication application; // Reset all test adapter return codes

  Quaternion q( M_PI/2.0f, Vector4( 1.0f, 2.0f, 3.0f, M_PI/5.0f ) );
...
int UtcDaliQuaternionCtorMatrixP01(void)
{
  ...
  Quaternion q1( M_PI/3.0f, Vector3( 1.0f, 2.0f, 3.0f ) );
  Quaternion q2( Mref );
...
int UtcDaliQuaternionToAxisAngleVector4P(void)
{
  TestApplication application; // Reset all test adapter return codes
  Quaternion q( 0.932f, 1.1f, 3.4f, 2.7f );
  float angle;
...
int UtcDaliQuaternionToAxisAngleVector4N(void)
{
  TestApplication application; // Reset all test adapter return codes
  Quaternion q( 1, 2, 3, 4 );
  float angle;
...
int UtcDaliQuaternionSetEulerP(void)
{
  ...
  // Test from euler angles
  Quaternion e1;
  e1.SetEuler( Radian( Degree( 45 ) ), 0.0f, 0.0f );
  Vector4 r1( 0.383f, 0.0f, 0.0f, 0.924f );

  Quaternion e2;
  e2.SetEuler( 0.0f, Radian( Degree( 75 ) ), 0.0f );
  Vector4 r2( 0.0f, 0.609f, 0.0f, 0.793f );

  Quaternion e3;
  e3.SetEuler( 0.0f, 0.0f, Radian( Degree( 135 ) ) );
  Vector4 r3( 0.0f, 0.0f, 0.924f, 0.383f );
