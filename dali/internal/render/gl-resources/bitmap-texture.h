...
public:
   ...
   */
  BitmapTexture(Integration::Bitmap* const bitmap, const Integration::Bitmap::PackedPixelsProfile * const bitmapPackedPixelsProfile, Context& context, SceneGraph::TextureCache::DiscardPolicy discardPolicy);
  ...
  BitmapTexture( unsigned int width, unsigned int height, Pixel::Format pixelFormat,
                 bool clearPixels, Context& context, SceneGraph::TextureCache::DiscardPolicy discardPolicy );
...
private:
  ...
  SceneGraph::TextureCache::DiscardPolicy mDiscardPolicy; ///< The bitmap discard policy
