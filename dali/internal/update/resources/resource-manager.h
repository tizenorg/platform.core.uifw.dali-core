                                      ...
                                      const Dali::MeshData& meshData )
{
  ...
  ResourcePolicy::Discardable discardable = (platform.GetResourceDataRetentionPolicy() == Integration::DALI_DISCARDS_ALL_DATA ) ? ResourcePolicy::DISCARD : ResourcePolicy::RETAIN;
