...
void RenderManager::AttachColorTextureToFrameBuffer( Render::FrameBuffer* frameBuffer, Render::NewTexture* texture )
{
  frameBuffer->AttachColorTexture( mImpl->context, texture );
}

void RenderManager::AttachDepthStencilTextureToFrameBuffer( Render::FrameBuffer* frameBuffer, Render::NewTexture* texture )
{
  frameBuffer->AttachDepthStencilTexture( mImpl->context, texture );
}
