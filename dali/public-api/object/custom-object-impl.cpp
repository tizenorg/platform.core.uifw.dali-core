...
CustomObject CustomObjectImpl::Self() const
{
  return CustomObject(mOwner);
}

void CustomObjectImpl::OnPropertySet( Property::Index index, Property::Value propertyValue )
{
}

CustomObjectImpl::CustomObjectImpl(bool requiresTouchEvents)
: mOwner(NULL)
{
}
