...
public:
  ...
  typedef std::pair< Actor*, Dimension > ActorDimensionPair;
...
public:
  ...
  /**
   * @copydoc Dali::Actor::FlagToRelayout()
   */
  void FlagToRelayout();
   ...
   */
  virtual bool RelayoutDependentOnChildren(
   ...
   * @return Return if the actor is dependent on it's children
   */
  virtual bool RelayoutDependentOnChildrenBase( Dimension dimension =
      ALL_DIMENSIONS );
   ...
   */
  bool RelayoutDependentOnDimension( Dimension dimension,
      Dimension dependentDimension );
   ...
   */
  void NegotiateDimension( Dimension dimension, const Vector2& allocatedSize,
   ...
   */
  void SetNegotiatedDimension( float negotiatedDimension, Dimension dimension =
      ALL_DIMENSIONS );
  ...
  /**
   * @copydoc Dali::Actor::SetRelayoutSizeFactor
   */
  void SetRelayoutSizeFactor( const Vector3& factor );

  /**
   * @copydoc Dali::Actor::GetRelayoutSizeFactor
   */
   ...
   */
  void SetLayoutNegotiated( bool negotiated, Dimension dimension =
      ALL_DIMENSIONS );
   ...
   */
  virtual float CalculateChildSize( const Dali::Actor& child,
      Dimension dimension );
...
public:
   ...
   */
  bool ScreenToLocal( float& localX, float& localY, float screenX,
      float screenY ) const;
   ...
   * @return True if the conversion succeeded.
   */
  bool ScreenToLocal( RenderTask& renderTask, float& localX, float& localY,
   ...
   * @return True if the conversion succeeded.
   */
  bool ScreenToLocal( const Matrix& viewMatrix, const Matrix& projectionMatrix,
      const Viewport& viewport, float& localX, float& localY, float screenX,
      float screenY ) const;
   ...
   */
  bool RayActorTest( const Vector4& rayOrigin, const Vector4& rayDir,
      Vector4& hitPointLocal, float& distance ) const;
  ...
  static bool DoConnectSignal( BaseObject* object,
      ConnectionTrackerInterface* tracker, const std::string& signalName,
   ...
   */
  static bool DoAction( BaseObject* object, const std::string& actionName,
...
public:
   ...
   * This should only be called by Animation, when the actor is resized using Animation::Resize().
   */
  virtual void OnSizeAnimation( Animation& animation,
...
protected:
   ...
   */
  void RecursiveConnectToStage( ActorContainer& connectionList,
      int index = -1 );
...
public:
   ...
   */
  virtual void GetDefaultPropertyIndices(
      Property::IndexContainer& indices ) const;
   ...
   */
  virtual Property::Index GetDefaultPropertyIndex(
   ...
   */
  virtual void SetDefaultProperty( Property::Index index,
      const Property::Value& propertyValue );

  /**
   * @copydoc Dali::Internal::Object::SetSceneGraphProperty()
   */
  virtual void SetSceneGraphProperty( Property::Index index,
      const CustomProperty& entry, const Property::Value& value );
   ...
   */
  virtual const SceneGraph::PropertyBase* GetSceneObjectAnimatableProperty(
      Property::Index index ) const;

  /**
   * @copydoc Dali::Internal::Object::GetSceneObjectInputProperty()
   */
  virtual const PropertyInputImpl* GetSceneObjectInputProperty(
      Property::Index index ) const;
