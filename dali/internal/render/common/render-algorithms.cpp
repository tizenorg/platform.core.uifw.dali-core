...
//todor MERGE <<<<<<< HEAD
    //todorscnow THIS NEEDS TO BE ADDED
    if( depthBufferEnabled )
//todor MERGE =======
    //todorscnow THIS NEEDS TO BE REMOVED
    //for ( size_t index = 0; index < count; ++index )
//todor MERGE >>>>>>> Do not merge - Clipping: Feasibility experiment
    {
      for ( size_t index = 0; index < count; ++index )
      {
...
#endif
      //todordel context.DepthMask( depthBufferEnabled && ( item.IsOpaque() || item.GetRenderer().RequiresDepthTest() ) );
//todor MERGE >>>>>>> Do not merge - Clipping: Feasibility experiment
