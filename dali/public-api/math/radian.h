...
// useful constants turns
static const Radian ANGLE_360 = Radian( Math::PI * 2.0f ); ///< 360 degree turn in radians
static const Radian ANGLE_270 = Radian( Math::PI * 1.5f ); ///< 270 degree turn in radians
static const Radian ANGLE_180 = Radian( Math::PI        ); ///< 180 degree turn in radians
static const Radian ANGLE_120 = Radian( Math::PI / 3.0f ); ///< 120 degree turn in radians
...
static const Radian ANGLE_30  = Radian( Math::PI / 6.0f ); ///< 30 degree turn in radians
