...
public:
  ...
  /**
   * Destructor Virtual even though this is not a base class to avoid triggering
...
private:
  ...
  std::vector< Integration::ShaderDataPtr > mShaderBinaryCache; ///< Cache of pre-compiled shaders.
