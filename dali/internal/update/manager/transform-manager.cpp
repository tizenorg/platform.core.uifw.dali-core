...
const Vector4& TransformManager::GetBoundingSphere( TransformId id )
{
  return mBoundingSpheres[ mIds[id] ];
}

void TransformManager::GetWorldMatrixAndSize( TransformId id, Matrix& worldMatrix, Vector3& size )
{
  unsigned int index = mIds[id];
