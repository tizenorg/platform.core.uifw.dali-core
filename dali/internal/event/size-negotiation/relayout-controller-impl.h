...
public:
  ...
  /**
   * @copydoc Dali::RelayoutController::RequestPreRelayout
   */
  void RequestPreRelayout( Dali::Actor actor );

  /**
   * @copydoc Dali::RelayoutController::RequestRelayout
   */
  void RequestRelayout( Dali::Actor& actor, Dimension dimension = ALL_DIMENSIONS );

  /**
   * @copydoc Dali::RelayoutController::RequestRelayoutTree
   */
  ...
  /**
   * @brief Conenct to the stage OnApplicationSceneCreated signal
   */
  void OnInitializationCompleted( IntrusivePtr<Stage> stage );
...
private:
  ...
  RawActorList mPreRequestActors;       ///< List of actors that have requested pre-relayout
  RelayoutContainerPtr mRelayoutStack;  ///< Stack for relayouting
