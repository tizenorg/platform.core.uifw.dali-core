...
public:
   ...
   * @param[in] touch The touch event details (Old API).
   * @param[in] touchHandle The touch event details.
   */
  void EmitTouchedSignal( const TouchEvent& touch, const TouchEventHandle& touchHandle );
  ...
  /**
    * @copydoc Dali::Stage::TouchEventSignal()
    */
  Dali::Stage::TouchEventSignalType& TouchEventSignal();
...
private:
  ...
  Dali::Stage::TouchEventSignalType               mTouchEventSignal;
