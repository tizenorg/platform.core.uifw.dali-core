...
#include <dali/devel-api/scripting/actor-enumeration-tables.h>
...
void Actor::SetClippingMode( Dali::ClippingMode::Type clippingMode )
{
  if( NULL != mNode )
  {
    //todor check node exists?
    //todor del
    std::string nodeName = mName;
    nodeName += ":node:";

    SetClippingInformationMessage( GetEventThreadServices(), *mNode, nodeName, clippingMode, 0, 0 );
  }
}

Dali::ClippingMode::Type Actor::GetClippingMode() const
{
  return Dali::ClippingMode::CLIPPING_ENABLED;//todor
}
...
void Actor::SetDefaultProperty( Property::Index index, const Property::Value& property )
{
  switch( index )
  {
    ...
    case Dali::Actor::Property::COLOR_MODE:
    {
      ...
      if( Scripting::GetEnumeration< Dali::ColorMode >( property.Get< std::string >().c_str(), Dali::EnumerationTables::ColorModeTable, Dali::EnumerationTables::ColorModeTableCount, mode ) )
      {
        SetColorMode( mode );
      }
      break;
    ...
    case Dali::Actor::Property::POSITION_INHERITANCE:
    {
      ...
      if( Scripting::GetEnumeration< PositionInheritanceMode >( property.Get< std::string >().c_str(), Dali::EnumerationTables::PositionInheritanceModeTable, Dali::EnumerationTables::PositionInheritanceModeTableCount, mode ) )
      {
    ...
    case Dali::Actor::Property::DRAW_MODE:
    {
      ...
      if( Scripting::GetEnumeration< DrawMode::Type >( property.Get< std::string >().c_str(), Dali::EnumerationTables::DrawMode::TypeTable, Dali::EnumerationTables::DrawMode::TypeTableCount, mode ) )
      {
        SetDrawMode( mode );
      }
      break;
    ...
    case Dali::Actor::Property::WIDTH_RESIZE_POLICY:
    {
      ...
      if( Scripting::GetEnumeration< ResizePolicy::Type >( property.Get< std::string >().c_str(), Dali::EnumerationTables::ResizePolicy::TypeTable, Dali::EnumerationTables::ResizePolicy::TypeTableCount, mode ) )
      {
    ...
    case Dali::Actor::Property::SIZE_SCALE_POLICY:
    {
      ...
      if( Scripting::GetEnumeration< SizeScalePolicy::Type >( property.Get< std::string >().c_str(), Dali::EnumerationTables::SizeScalePolicy::TypeTable, Dali::EnumerationTables::SizeScalePolicy::TypeTableCount, mode ) )
      {
    ...
    case Dali::Actor::Property::CLIPPING_MODE:
    {
      ...
      if( Scripting::GetEnumeration< ClippingMode::Type >( property.Get< std::string >().c_str(), Dali::EnumerationTables::ClippingMode::TypeTable, Dali::EnumerationTables::ClippingMode::TypeTableCount, mode ) )
      {
...
Property::Value Actor::GetDefaultProperty( Property::Index index ) const
{
  ...
  switch( index )
  {
    ...
    case Dali::Actor::Property::COLOR_MODE:
    {
      value = Scripting::GetEnumerationName< Dali::ColorMode >( GetColorMode(), Dali::EnumerationTables::ColorModeTable, Dali::EnumerationTables::ColorModeTableCount );
      break;
    }

    case Dali::Actor::Property::POSITION_INHERITANCE:
    {
      value = Scripting::GetEnumerationName< Dali::PositionInheritanceMode >( GetPositionInheritanceMode(), Dali::EnumerationTables::PositionInheritanceModeTable, Dali::EnumerationTables::PositionInheritanceModeTableCount );
      break;
    }

    case Dali::Actor::Property::DRAW_MODE:
    {
      value = Scripting::GetEnumerationName< Dali::DrawMode::Type >( GetDrawMode(), Dali::EnumerationTables::DrawMode::TypeTable, Dali::EnumerationTables::DrawMode::TypeTableCount );
      break;
    }
    ...
    case Dali::Actor::Property::WIDTH_RESIZE_POLICY:
    {
      value = Scripting::GetLinearEnumerationName< ResizePolicy::Type >( GetResizePolicy( Dimension::WIDTH ), Dali::EnumerationTables::ResizePolicy::TypeTable, Dali::EnumerationTables::ResizePolicy::TypeTableCount );
      break;
    }

    case Dali::Actor::Property::HEIGHT_RESIZE_POLICY:
    {
      value = Scripting::GetLinearEnumerationName< ResizePolicy::Type >( GetResizePolicy( Dimension::HEIGHT ), Dali::EnumerationTables::ResizePolicy::TypeTable, Dali::EnumerationTables::ResizePolicy::TypeTableCount );
      break;
    }

    case Dali::Actor::Property::SIZE_SCALE_POLICY:
    {
      value = Scripting::GetLinearEnumerationName< SizeScalePolicy::Type >( GetSizeScalePolicy(), Dali::EnumerationTables::SizeScalePolicy::TypeTable, Dali::EnumerationTables::SizeScalePolicy::TypeTableCount );
      break;
    }
    ...
    case Dali::Actor::Property::CLIPPING_MODE:
    {
      value = Scripting::GetLinearEnumerationName< ClippingMode::Type >( GetClippingMode(), Dali::EnumerationTables::ClippingMode::TypeTable, Dali::EnumerationTables::ClippingMode::TypeTableCount );
      break;
    }
