...
namespace
{
 static TransformManager::TransformComponentAnimatable gDefaultTransformComponentAnimatable = { Vector3(1.0f,1.0f,1.0f), Quaternion(1.0f,0.0f,0.0f,0.0f), Vector3(0.0f,0.0f,0.0f) };
 static TransformManager::TransformComponentStatic gDefaultTransformComponentStatic = { Vector3(0.5f,0.5f,0.5f), Vector3(0.0f,0.0f,1.0f) };
}
...
TransformId TransformManager::CreateTransform()
{
  ...
  //Set default values
  memcpy( &mTxComponentAnimatable[mComponentCount], &gDefaultTransformComponentAnimatable, sizeof(TransformComponentAnimatable ) );
  memcpy( &mTxComponentStatic[mComponentCount], &gDefaultTransformComponentStatic, sizeof( TransformComponentStatic ) );
  memcpy( &mTxComponentAnimatableBaseValue[mComponentCount], &gDefaultTransformComponentAnimatable, sizeof(TransformComponentAnimatable ) );
