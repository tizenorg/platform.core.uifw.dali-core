...
protected: // For derived classes
  ...
  enum ActorFlags
  {
    ...
    REQUIRES_TOUCH_EVENTS         = 1 << 0,     ///< True if the OnTouchEvent() callback is required.
    NO_SIZE_NEGOTIATION           = 1 << 1,     ///< True if control does not need size negotiation, i.e. it can be skipped in the algorithm
