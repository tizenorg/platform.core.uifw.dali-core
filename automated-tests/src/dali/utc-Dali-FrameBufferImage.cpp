...
int UtcDaliFrameBufferImageAttachments01(void)
{
  ...
  tet_infoline("UtcDaliFrameBufferImageNew01 - FrameBufferImage::New(unsigned int, unsigned int, Pixel::Format, RenderBuffer::Format)");

  // invoke default handle constructor
  FrameBufferImage image;

  // initialise handle
  image = FrameBufferImage::New(64, 64, Pixel::RGBA8888, RenderBuffer::COLOR);            // create framebuffer with the same dimensions as the stage
  ImageActor actor=ImageActor::New(image);
  Stage::GetCurrent().Add(actor);
...
int UtcDaliFrameBufferImageAttachments02(void)
{
  ...
  // initialise handle
  image = FrameBufferImage::New(64, 64, Pixel::RGBA8888, RenderBuffer::COLOR_DEPTH);            // create framebuffer with the same dimensions as the stage
  ImageActor actor=ImageActor::New(image);
  Stage::GetCurrent().Add(actor);
...
int UtcDaliFrameBufferImageAttachments03(void)
{
  ...
  // initialise handle
  image = FrameBufferImage::New(64, 64, Pixel::RGBA8888, RenderBuffer::COLOR_STENCIL);            // create framebuffer with the same dimensions as the stage
  ImageActor actor=ImageActor::New(image);
  Stage::GetCurrent().Add(actor);
...
int UtcDaliFrameBufferImageAttachments04(void)
{
  ...
  // initialise handle
  image = FrameBufferImage::New(64, 64, Pixel::RGBA8888, RenderBuffer::COLOR_DEPTH_STENCIL);            // create framebuffer with the same dimensions as the stage
  ImageActor actor=ImageActor::New(image);
  Stage::GetCurrent().Add(actor);
