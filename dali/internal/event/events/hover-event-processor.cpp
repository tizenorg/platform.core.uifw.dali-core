...
HoverEventProcessor::ActorObserver::ActorObserver()
: mActor ( NULL ),
...
Actor* HoverEventProcessor::ActorObserver::GetActor()
{
  return mActorDisconnected ? NULL : mActor;
}

void HoverEventProcessor::ActorObserver::SetActor( Actor* actor )
{
  DALI_LOG_TRACE_METHOD( gLogFilter );
...
void HoverEventProcessor::ActorObserver::ResetActor()
{
  if ( mActor )
  {
...
void HoverEventProcessor::ActorObserver::SceneObjectRemoved( ProxyObject& proxy )
{
  DALI_LOG_TRACE_METHOD( gLogFilter );
...
void HoverEventProcessor::ActorObserver::ProxyDestroyed(ProxyObject& proxy)
{
  DALI_LOG_TRACE_METHOD( gLogFilter );
