                                   ...
                                   const Property::Value& propertyValue )
{
  ...
  switch( index )
  {
    ...
    {
      SceneGraph::PropertyMessage<Vector4>::Send( updateManager, mSceneObject, &mSceneObject->mColor, &SceneGraph::AnimatableProperty<Vector4>::Bake, propertyValue.Get<Vector4>() );
      break;
    }
    ...
    {
      SceneGraph::PropertyMessage<Vector4>::Send( updateManager, mSceneObject, &mSceneObject->mBlendColor, &SceneGraph::AnimatableProperty<Vector4>::Bake, propertyValue.Get<Vector4>() );
      break;
    }
  }
}
