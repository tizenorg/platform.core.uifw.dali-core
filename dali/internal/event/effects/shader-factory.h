...
public:
  ...
  /**
   * @brief Saves shader to filesystem.
   * @override
   */
...
/*inline MessageBase* ShaderCompiledMessage( ShaderFactory& factory, Integration::ShaderDataPtr shaderData )
{
  return new MessageValue1< ShaderFactory, Integration::ShaderDataPtr >( &factory,
                                                            &ShaderFactory::Dispatch,
                                                            shaderData );
}*/
