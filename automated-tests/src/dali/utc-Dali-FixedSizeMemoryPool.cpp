...
int UtcDaliFixedSizeMemoryPoolObjectAllocation(void)
{
  ...
  // Allocate an object
  TestObject* testObject1 = allocator.Allocate();
  DALI_TEST_CHECK( testObject1 );
  DALI_TEST_EQUALS( gTestObjectConstructed, 1, TEST_LOCATION );
  ...
  TestObject* testObject2 = allocator.Allocate();
  ...
  // Reset and allocate an object using AllocateRaw
  gTestObjectConstructed = 0;
  gTestObjectDestructed = 0;
  gTestObjectMethod = 0;
  gTestObjectDataAccess = 0;
  ...
  TestObject* testObject3 = new ( allocator.AllocateRaw() ) TestObject();
  DALI_TEST_CHECK( testObject3 );
  DALI_TEST_EQUALS( gTestObjectConstructed, 1, TEST_LOCATION );

  testObject3->Method();
  DALI_TEST_EQUALS( gTestObjectMethod, 1, TEST_LOCATION );

  testObject3->DataAccess();
  DALI_TEST_EQUALS( gTestObjectDataAccess, 1, TEST_LOCATION );

  allocator.Free( testObject3 );
  DALI_TEST_EQUALS( gTestObjectDestructed, 1, TEST_LOCATION );
