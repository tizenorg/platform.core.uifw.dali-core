...
int UtcDaliFixedSizeMemoryPoolCreate(void)
{
  ...
  FixedSizeMemoryPool memoryPool = FixedSizeMemoryPool::New( TypeSizeWithAlignment< TestObject >::size );

  TestObject* testObject1 = new (memoryPool.NewAllocation()) TestObject();
  ...
  memoryPool.DeleteAllocation( testObject1 );
...
int UtcDaliFixedSizeMemoryPoolStressTest(void)
{
  ...
  FixedSizeMemoryPool memoryPool = FixedSizeMemoryPool::New( TypeSizeWithAlignment< TestObject >::size, initialCapacity, maximumCapacity );
  ...
  {
    TestObject* testObject = new (memoryPool.NewAllocation()) TestObject();
  ...
  for( unsigned int i = 0; i < numObjects; ++i )
  {
    ...
    memoryPool.DeleteAllocation( objects[i] );
  }
...
int UtcDaliFixedSizeMemoryPoolObjectAllocation(void)
{
  gTestObjectConstructed = 0;
  gTestObjectDestructed = 0;
  gTestObjectMethod = 0;
  ...
  FixedSizeObjectAllocator< TestObject > allocator;

  TestObject* testObject1 = allocator.New();
  DALI_TEST_CHECK( testObject1 );
  DALI_TEST_EQUALS( gTestObjectConstructed, 1, TEST_LOCATION );
  ...
  TestObject* testObject2 = allocator.New();
  ...
  allocator.Delete( testObject2 );
  DALI_TEST_EQUALS( gTestObjectDestructed, 1, TEST_LOCATION );

  END_TEST;
}

int UtcDaliFixedSizeMemoryPoolObjectAllocationPOD(void)
{
  FixedSizeObjectAllocator< bool > allocator;

  bool* testObject1 = allocator.New();
  DALI_TEST_CHECK( testObject1 );
  ...
  bool* testObject2 = allocator.New();
  DALI_TEST_CHECK( testObject2 );
