...
RenderMeshDispatcher::RenderMeshDispatcher(
...
void RenderMeshDispatcher::AddRenderMesh( BufferIndex updateBufferIndex, RenderMesh* renderMesh )
{
 ...
 */
void RenderMeshDispatcher::RemoveRenderMesh( BufferIndex updateBufferIndex, RenderMesh* renderMesh )
{
  // Define the type of message
  typedef  MessageValue1< RenderMeshOwner, OwnerPointer<RenderMesh> > DerivedType;
