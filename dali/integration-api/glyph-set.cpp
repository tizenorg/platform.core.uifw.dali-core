...
void GlyphSet::AddCharacter(ImageDataPtr imageData, const GlyphMetrics& glyphMetrics) /// void GlyphSet::AddCharacter(BitmapPtr bitmapData, const GlyphMetrics& glyphMetrics) ///! [ImageData]
{
