...
public:
   ...
   */
  void SetTextureSet( TextureSet* textureSet );
...
/// Messages
inline void SetTextureSetMessage( EventThreadServices& eventThreadServices, const Renderer& renderer, const TextureSet& textureSet )
{
  ...
  new (slot) LocalType( &renderer, &Renderer::SetTextureSet, const_cast<TextureSet*>(&textureSet) );
}
