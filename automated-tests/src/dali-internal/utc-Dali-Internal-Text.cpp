...
int UtcDaliTextGetTextArray(void)
{
  ...
  const Internal::TextArray& textArray1 = text.GetImplementation().GetTextArray();
  ...
  const Internal::TextArray& textArray2 = Internal::GetTextArray( text );
  ...
  const Internal::TextArray& textArray3 = Internal::GetTextArray( Text() );
