                                      ...
                                      const Dali::ImageAttributes& actual ) const
{
  ...
  return (requested.GetScalingMode() ==  actual.GetScalingMode()) &&
          ...
          (std::abs(static_cast<int>(requested.GetWidth())  -  static_cast<int>(actual.GetWidth()))  < actual.GetWidth()  * mMaxScale) &&
          (std::abs(static_cast<int>(requested.GetHeight()) -  static_cast<int>(actual.GetHeight())) < actual.GetHeight() * mMaxScale);
}
