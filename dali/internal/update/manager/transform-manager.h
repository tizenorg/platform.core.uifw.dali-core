...
public:
  ...
  {
    return mLocalMatrixDirty[mIds[id]] == 1u;
  }
   ...
   */
  const float& GetVector3PropertyComponentValue(TransformId id, TransformManagerProperty property, unsigned int component );
