  ...
  mProcessingEvent(false)
{
  ...
  SceneGraph::TextureCache::DiscardPolicy discardPolicy = (policy == Integration::DALI_RETAINS_DATA ? SceneGraph::TextureCache::RETAIN : SceneGraph::TextureCache::DISCARD );
