...
public:
   ...
   * to the constructor
   * @param[in] f One of the predefined alpha functions
   * @return The alpha function
   */
  AlphaFunction( PredefinedFunction f);

  /**
   * @brief Constructor.
   * Creates an alpha function object using a pointer to an alpha function passed as a paramter
   * to the constructor
   * @param[in] f A pointer to an alpha function
   * @return The alpha function
   */
  AlphaFunction( AlphaFunctionPrototype f);
   ...
   * @return One of the predefined alpha functions
   */
