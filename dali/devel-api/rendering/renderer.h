...
#include <dali/devel-api/rendering/texture-set.h> // Dali::Material
...
/**
 * @brief Renderer is a handle to an object used to show content by combining a Geometry, an TextureSet and a shader
 */
