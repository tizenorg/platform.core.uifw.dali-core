...
public: // Default properties
  ...
  Vector3PropertyHandler         mPosition;      ///< Local transform; distance between parent-origin & anchor-point
  //AnimatableProperty<Quaternion> mOrientation;   ///< Local transform; rotation relative to parent node
  QuaternionPropertyHandler      mOrientation;   ///< Local transform; rotation relative to parent node
  //AnimatableProperty<Vector3>    mScale;         ///< Local transform; scale relative to parent node
  Vector3PropertyHandler          mScale;         ///< Local transform; scale relative to parent node
