...
public:
   ...
   */
  CompressedBitmapTexture( Internal::BitmapCompressed* const bitmap, Context& context, SceneGraph::TextureCache::DiscardPolicy discardPolicy );
...
private:
  ...
  SceneGraph::TextureCache::DiscardPolicy mDiscardPolicy;
