...
Internal::Texture* NewBitmapTexture( Integration::Bitmap* const bitmap, Context& context, SceneGraph::TextureCache::DiscardPolicy discardPolicy )
{
...
Internal::Texture* NewBitmapTexture( unsigned int      width,
                                     ...
                                     bool              clearPixels,
                                     Context&          context,
                                     SceneGraph::TextureCache::DiscardPolicy discardPolicy )
{
