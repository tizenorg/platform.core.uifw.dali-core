...
public: // Object::Observer methods
   ...
   */
  virtual void Apply( Property source, Property target, const Vector2& range) = 0;
...
protected:
  ...
  /**
   * @brief Adds the object to the list of observed objects if it is not there already
   * The constrainer will remove all the constraints which has created when it is destroyed
   *
