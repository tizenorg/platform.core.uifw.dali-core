 ...
 */
DALI_IMPORT_API void LogResourceTracking( const Dali::ResourceTrackMessage::Type message,
                                          const void* ptr,
...
public:
   ...
   * @param p4 parameter4
   */
  virtual void AddMessage( const Dali::ResourceTrackMessage::Type message,
                           const void* ptr,
                           const unsigned int p1,
                           const unsigned int p2,
                           const unsigned int p3,
                           const unsigned int p4 ) = 0;
};
