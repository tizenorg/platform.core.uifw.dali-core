...
static const bool      DEFAULT_AUTOMATIC_FONT_DETECTION = true;
...
struct TextActorParameters::Impl
{
  ...
  Impl( const TextStyle& style, bool fontDetection )
  : mStyle( style ),
...
TextActorParameters::TextActorParameters( const TextStyle& style, bool fontDetection )
...
{
  return ( NULL == mImpl ) ? DEFAULT_AUTOMATIC_FONT_DETECTION : mImpl->mFontDetection;
}
