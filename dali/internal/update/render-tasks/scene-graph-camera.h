...
inline void SetTypeMessage( EventThreadServices& eventThreadServices, const Camera& attachment, Dali::Camera::Type parameter )
{
  ...
  new (slot) LocalType( &attachment, &Camera::SetType, parameter );
}

inline void SetProjectionModeMessage( EventThreadServices& eventThreadServices, const Camera& attachment, Dali::Camera::ProjectionMode parameter )
{
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalProjectionMode( &attachment, &Camera::SetProjectionMode, parameter );
}

inline void SetFieldOfViewMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetFieldOfView, parameter );
}

inline void SetAspectRatioMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  typedef MessageValue1< Camera, float > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetAspectRatio, parameter );
}

inline void SetStereoBiasMessage( EventThreadServices& eventThreadServices, const Camera& attachment, const Vector2& parameter )
{
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetStereoBias, parameter );
}

inline void SetLeftClippingPlaneMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  typedef MessageValue1< Camera, float > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetLeftClippingPlane, parameter );
}

inline void SetRightClippingPlaneMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  typedef MessageValue1< Camera, float > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetRightClippingPlane, parameter );
}

inline void SetTopClippingPlaneMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  typedef MessageValue1< Camera, float > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetTopClippingPlane, parameter );
}

inline void SetBottomClippingPlaneMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  typedef MessageValue1< Camera, float > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetBottomClippingPlane, parameter );
}

inline void SetNearClippingPlaneMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  typedef MessageValue1< Camera, float > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetNearClippingPlane, parameter );
}

inline void SetFarClippingPlaneMessage( EventThreadServices& eventThreadServices, const Camera& attachment, float parameter )
{
  typedef MessageValue1< Camera, float > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetFarClippingPlane, parameter );
}

inline void SetTargetPositionMessage( EventThreadServices& eventThreadServices, const Camera& attachment, const Vector3& parameter )
{
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetTargetPosition, parameter );
}

inline void SetInvertYAxisMessage( EventThreadServices& eventThreadServices, const Camera& attachment, bool parameter )
{
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &attachment, &Camera::SetInvertYAxis, parameter );
}
