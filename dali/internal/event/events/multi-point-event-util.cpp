...
bool HIERARCHY_GEOMETRY(false);
bool HIERARCHY_SENSITIVITY(false);
bool HIERARCHY_TOUCH_REQUIRED(false);
bool HIERARCHY_HOVER_REQUIRED(false);
bool HIERARCHY_HITTABLE(false);

const Debug::LogLevel HIERARCHY_DEBUG_LOG_LEVEL( Debug::Verbose );
