...
public:
   ...
   */
  virtual void NotifyProperty( SceneGraph::PropertyNotification* propertyNotification ) = 0;
};
 ...
 */
inline MessageBase* PropertyChangedMessage( PropertyNotifier& notifier, SceneGraph::PropertyNotification* propertyNotification )
{
  return new MessageValue1< PropertyNotifier, SceneGraph::PropertyNotification* >( &notifier,
