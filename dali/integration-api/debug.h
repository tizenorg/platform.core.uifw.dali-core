 ...
 *
 */
DALI_IMPORT_API bool IsResourceTrackingManagerEnabled();
 ...
 * @param bool enabled
 */
DALI_IMPORT_API void SetResourceTrackingManagerEnabled( bool enabled );
 ...
 */
#define DALI_RESOURCE_INFO( message, ptr, p1, p2, p3, p4 ) if ( Dali::Integration::Log::IsResourceTrackingManagerEnabled() ) \
