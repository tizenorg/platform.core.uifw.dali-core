...
public:
   ...
   */
  Dali::SingletonService::ObjectCreatedSignalV2& ObjectCreatedSignal();

  /**
   * @copydoc Dali::SingletonService::ObjectDestroyedSignal()
   */
  Dali::SingletonService::ObjectDestroyedSignalV2& ObjectDestroyedSignal();
...
private:
  Dali::SingletonService::ObjectCreatedSignalV2 mObjectCreatedSignalV2;
  Dali::SingletonService::ObjectDestroyedSignalV2 mObjectDestroyedSignalV2;
