...
ImageTicketPtr ResourceClient::AddBitmapImage( const Integration::BitmapPtr& bitmap )
{
...
void ResourceClient::UploadBitmap( ResourceId destId, const Integration::BitmapPtr& bitmap, std::size_t xOffset, std::size_t yOffset)
{
  RequestUploadBitmapMessage( mEventThreadServices,
                              mResourceManager,
                              destId,
