...
protected:
  ...
  // Signals
  Dali::Actor::TouchSignalType             mTouchedSignalType;
  Dali::Actor::HoverSignalType             mHoveredSignalType;
  Dali::Actor::MouseWheelEventSignalType   mMouseWheelEventSignalType;
  Dali::Actor::SetSizeSignalType           mSetSizeSignalType;
  Dali::Actor::OnStageSignalType           mOnStageSignalType;
  Dali::Actor::OffStageSignalType          mOffStageSignalType;
