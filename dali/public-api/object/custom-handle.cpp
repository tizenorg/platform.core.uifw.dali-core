...
CustomObjectImpl& CustomHandle::GetImplementation()
{
...
const CustomObjectImpl& CustomHandle::GetImplementation() const
{
...
CustomHandle::CustomHandle(CustomObjectImpl& implementation)
