...
#define DALI_ANIMATABLE_PROPERTY_REGISTRATION_WITH_VALUE_INTERNAL( count, typeRegistrationObject, objectNamespace, objectType, text, value, enumIndex) \
...
#define DALI_ANIMATABLE_PROPERTY_REGISTRATION_WITH_VALUE( objectNamespace, objectType, text, value, enumIndex ) \
  DALI_ANIMATABLE_PROPERTY_REGISTRATION_WITH_VALUE_INTERNAL( __COUNTER__, typeRegistration, objectNamespace, objectType, text, value, enumIndex )
