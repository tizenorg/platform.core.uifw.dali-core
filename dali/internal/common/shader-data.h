...
public:
   ...
   */
  ShaderData(const std::string& vertexSource, const std::string& fragmentSource, const Dali::Shader::Hints::Value hints)
  : mShaderHash( -1 ),
...
public: // API
   ...
   * @return the hints
   */
  Dali::Shader::Hints::Value GetHints() const
  {
    return mHints;
  }
  /**
...
private: // Data
  ...
  Dali::Shader::Hints::Value  mHints;          ///< take a hint
