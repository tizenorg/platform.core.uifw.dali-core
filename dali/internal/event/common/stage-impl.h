...
private:
  ...
  Dali::Stage::KeyEventSignalType                 mKeyEventSignalType;

  // The event processing finished signal
  Dali::Stage::EventProcessingFinishedSignalType  mEventProcessingFinishedSignalType;

  // The touched signal
  Dali::Stage::TouchedSignalType                  mTouchedSignalType;
