...
DALI_PROPERTY( "uniform-name",  STRING,  true, false,  true, Dali::Sampler::Property::UNIFORM_NAME )
                                  ...
                                  const Property::Value& propertyValue )
{
  switch( index )
  {
    ...
    case Dali::Sampler::Property::UNIFORM_NAME:
    {
      SetTextureUnitUniformName(propertyValue.Get<std::string>());
      break;
    }
  }
}
