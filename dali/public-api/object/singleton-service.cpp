...
SingletonService::ObjectCreatedSignalType& SingletonService::ObjectCreatedSignal()
{
  return GetImplementation(*this).ObjectCreatedSignal();
}

SingletonService::ObjectDestroyedSignalType& SingletonService::ObjectDestroyedSignal()
{
