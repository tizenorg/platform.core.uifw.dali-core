    ...
    size_t elementBufferCount )
{
  ...
  if( mIndexBuffer )
  {
    ...
    firstIndex = elementBufferOffset * sizeof(GLushort);
  }
  ...
  switch(mGeometryType)
  {
    case Dali::Geometry::TRIANGLES:
    {
      if( numIndices )
      {
        context.DrawElements(GL_TRIANGLES, numIndices, GL_UNSIGNED_SHORT, reinterpret_cast<void*>(firstIndex) );
      }
      else
      {
    ...
    case Dali::Geometry::LINES:
    {
      if( numIndices )
      {
        context.DrawElements(GL_LINES, numIndices, GL_UNSIGNED_SHORT, reinterpret_cast<void*>(firstIndex) );
      }
      else
      {
        unsigned int numVertices = mVertexBuffers[0]->GetElementCount();
    ...
    case Dali::Geometry::TRIANGLE_STRIP:
    {
      if( numIndices )
      {
        context.DrawElements(GL_TRIANGLE_STRIP, numIndices, GL_UNSIGNED_SHORT, reinterpret_cast<void*>(firstIndex) );
      }
      else
      {
        unsigned int numVertices = mVertexBuffers[0]->GetElementCount();
    ...
    case Dali::Geometry::TRIANGLE_FAN:
    {
      if( numIndices )
      {
        context.DrawElements(GL_TRIANGLE_FAN, numIndices, GL_UNSIGNED_SHORT, reinterpret_cast<void*>(firstIndex) );
      }
      else
      {
        unsigned int numVertices = mVertexBuffers[0]->GetElementCount();
    ...
    case Dali::Geometry::LINE_LOOP:
    {
      if( numIndices )
      {
        context.DrawElements(GL_LINE_LOOP, numIndices, GL_UNSIGNED_SHORT, reinterpret_cast<void*>(firstIndex) );
      }
      else
      {
        unsigned int numVertices = mVertexBuffers[0]->GetElementCount();
    ...
    case Dali::Geometry::LINE_STRIP:
    {
      if( numIndices )
      {
        context.DrawElements(GL_LINE_STRIP, numIndices, GL_UNSIGNED_SHORT, reinterpret_cast<void*>(firstIndex) );
      }
      else
      {
        unsigned int numVertices = mVertexBuffers[0]->GetElementCount();
