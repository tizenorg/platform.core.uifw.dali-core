                              ...
                              const MaterialIPtr    material )
{
  ...
  SetMeshMessage( mEventThreadServices, *mSceneObject, meshId, materialSceneObject, boneCount );
}
...
void MeshAttachment::SetMaterial( MaterialIPtr material )
{
  ...
  {
    // sceneObject is being used in a separate thread; queue a message to set
    SetMaterialMessage( mEventThreadServices, *mSceneObject, materialSceneObject );
  }
}
...
void MeshAttachment::OnStageConnection2()
{
  ...
  SetMaterialMessage( mEventThreadServices, sceneObject, materialSceneObject );
...
void MeshAttachment::SetBoneNode( SceneGraph::Node* node, size_t boneIdx )
{
  ...
  SetBoneNodeMessage( mEventThreadServices, *mSceneObject, node, boneIdx, boneCount );
}
