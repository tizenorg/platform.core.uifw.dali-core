...
template <>
inline Property::Type Get<AngleAxis>()        { return Property::ORIENTATION; } // Orientation has two representations
template <>
inline Property::Type Get<Quaternion>()       { return Property::ORIENTATION; } // Orientation has two representations
template <>
