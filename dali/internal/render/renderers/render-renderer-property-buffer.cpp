...
unsigned int RenderPropertyBuffer::EnableVertexAttributes( Context& context, BufferIndex bufferIndex, Vector<GLint>& vAttributeLocation, unsigned int base )
{
...
//  }
  ...
  {
    GLint attributeLocation = vAttributeLocation[i+base];
