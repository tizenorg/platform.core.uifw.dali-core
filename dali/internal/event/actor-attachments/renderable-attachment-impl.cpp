...
void RenderableAttachment::SetSortModifier(float modifier)
{
  ...
  SetSortModifierMessage( mEventThreadServices, GetSceneObject(), modifier );
}
...
void RenderableAttachment::SetCullFace( CullFaceMode mode )
{
  ...
  SetCullFaceMessage( mEventThreadServices, GetSceneObject(), mode );
}
...
void RenderableAttachment::SetBlendMode( BlendingMode::Type mode )
{
  ...
  // attachment is being used in a separate thread; queue a message to set the value
  SetBlendingModeMessage( mEventThreadServices, GetSceneObject(), mode );
}
                                         ...
                                         BlendingFactor::Type srcFactorAlpha, BlendingFactor::Type destFactorAlpha )
{
  ...
  // attachment is being used in a separate thread; queue a message to set the value
  SetBlendingOptionsMessage( mEventThreadServices, GetSceneObject(), mBlendingOptions.GetBitmask() );
}
...
void RenderableAttachment::SetBlendColor( const Vector4& color )
{
  ...
  {
    // attachment is being used in a separate thread; queue a message to set the value
    SetBlendColorMessage( mEventThreadServices, GetSceneObject(), color );
  }
}
...
void RenderableAttachment::SetFilterMode( FilterMode::Type minFilter, FilterMode::Type magFilter )
{
  ...
  SetSamplerMessage( mEventThreadServices, GetSceneObject(), mSamplerBitfield );
}
...
void RenderableAttachment::SetShaderEffect(ShaderEffect& effect)
{
  if ( OnStage() )
  {
    ...
    ApplyShaderMessage( mEventThreadServices, GetSceneObject(), shader );
...
void RenderableAttachment::RemoveShaderEffect()
{
  if ( OnStage() )
  {
    RemoveShaderMessage( mEventThreadServices, GetSceneObject() );
