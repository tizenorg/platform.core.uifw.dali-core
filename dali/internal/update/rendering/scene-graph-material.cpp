...
{
//Memory pool used to allocate new materials
Dali::Internal::MemoryPoolObjectAllocator<Dali::Internal::SceneGraph::Material> materialMemoryPool;
}
...
{
  void* memBlock = materialMemoryPool.AllocateRaw();
  Material* material = new (memBlock) Material();
  return material;
}
...
{
  materialMemoryPool.Free( static_cast<Material*>( ptr ) );
}
