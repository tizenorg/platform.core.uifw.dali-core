...
public:
                    ...
                    typename ParameterType< P >::PassingType value )
  {
    ...
    unsigned int* slot = updateManager.ReserveMessageSlot( sizeof( NodePropertyMessage ) );
...
public:
  ...
  {
    // Reserve some memory inside the message queue
    unsigned int* slot = updateManager.ReserveMessageSlot( sizeof( NodePropertyComponentMessage ) );
