...
void Actor::SetPosition(const Vector3& position)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mPosition, &AnimatableProperty<Vector3>::Bake, position );
  }
}
...
void Actor::SetX(float x)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mPosition, &AnimatableProperty<Vector3>::BakeX, x );
  }
}
...
void Actor::SetY(float y)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mPosition, &AnimatableProperty<Vector3>::BakeY, y );
  }
}
...
void Actor::SetZ(float z)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mPosition, &AnimatableProperty<Vector3>::BakeZ, z );
  }
}
...
void Actor::TranslateBy(const Vector3& distance)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mPosition, &AnimatableProperty<Vector3>::BakeRelative, distance );
  }
}
...
void Actor::SetOrientation(const Quaternion& orientation)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Quaternion>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mOrientation, &AnimatableProperty<Quaternion>::Bake, orientation );
  }
}
...
void Actor::RotateBy(const Radian& angle, const Vector3& axis)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Quaternion>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mOrientation, &AnimatableProperty<Quaternion>::BakeRelative, Quaternion(angle, axis) );
  }
}
...
void Actor::RotateBy(const Quaternion& relativeRotation)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Quaternion>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mOrientation, &AnimatableProperty<Quaternion>::BakeRelative, relativeRotation );
  }
}
...
void Actor::SetScale(const Vector3& scale)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mScale, &AnimatableProperty<Vector3>::Bake, scale );
  }
}
...
void Actor::SetScaleX( float x )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mScale, &AnimatableProperty<Vector3>::BakeX, x );
  }
}
...
void Actor::SetScaleY( float y )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mScale, &AnimatableProperty<Vector3>::BakeY, y );
  }
}
...
void Actor::SetScaleZ( float z )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mScale, &AnimatableProperty<Vector3>::BakeZ, z );
  }
}
...
void Actor::ScaleBy(const Vector3& relativeScale)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mScale, &AnimatableProperty<Vector3>::BakeRelativeMultiply, relativeScale );
  }
}
...
void Actor::SetVisible(bool visible)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<bool>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mVisible, &AnimatableProperty<bool>::Bake, visible );
  }
}
...
void Actor::SetOpacity(float opacity)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector4>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mColor, &AnimatableProperty<Vector4>::BakeW, opacity );
  }
}
...
void Actor::SetColor(const Vector4& color)
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Vector4>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mColor, &AnimatableProperty<Vector4>::Bake, color );
  }
}
...
void Actor::SetColorRed( float red )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector4>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mColor, &AnimatableProperty<Vector4>::BakeX, red );
  }
}
...
void Actor::SetColorGreen( float green )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector4>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mColor, &AnimatableProperty<Vector4>::BakeY, green );
  }
}
...
void Actor::SetColorBlue( float blue )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector4>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mColor, &AnimatableProperty<Vector4>::BakeZ, blue );
  }
}
...
void Actor::SetSize(const Vector3& size)
{
  if( NULL != mNode )
  {
    ...
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mSize, &AnimatableProperty<Vector3>::Bake, mSize );
...
void Actor::SetWidth( float width )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mSize, &AnimatableProperty<Vector3>::BakeX, width );
  }
}
...
void Actor::SetHeight( float height )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mSize, &AnimatableProperty<Vector3>::BakeY, height );
  }
}
...
void Actor::SetDepth( float depth )
{
  ...
  {
    // mNode is being used in a separate thread; queue a message to set the value & base value
    SceneGraph::NodePropertyComponentMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, &mNode->mSize, &AnimatableProperty<Vector3>::BakeZ, depth );
  }
}
  ...
  if( !mDynamicsData->body )
  {
    ...
    if( OnStage() )
    {
      ...
      if( world )
      {
        ...
        {
          mDynamicsData->body->Connect(*Stage::GetCurrent());
        }
      }
    }
  }
  ...
  if( world )
  {
    if( NULL != mDynamicsData )
    {
      ...
      if( !joint )
      {
        ...
        {
          joint->Connect(*Stage::GetCurrent());
        }
  ...
  if( NULL != mDynamicsData )
  {
    ...
    for( ; it != endIt; ++it )
    {
      if( it->second == joint.Get() )
      {
        ...
        {
          joint->Disconnect(*Stage::GetCurrent());
        }
...
void Actor::DisconnectDynamics()
{
  if( NULL != mDynamicsData && mDynamicsData->body )
  {
    if( OnStage() )
    {
      mDynamicsData->body->Disconnect(*Stage::GetCurrent());
...
void Actor::SetSceneGraphProperty( Property::Index index, const CustomProperty& entry, const Property::Value& value )
{
  ...
  switch ( entry.type )
  {
    case Property::BOOLEAN:
    {
      ...
      SceneGraph::NodePropertyMessage<bool>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property, &AnimatableProperty<bool>::Bake, value.Get<bool>() );
    ...
    case Property::FLOAT:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<float>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property, &AnimatableProperty<float>::Bake, value.Get<float>() );
    ...
    case Property::INTEGER:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<int>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property, &AnimatableProperty<int>::Bake, value.Get<int>() );
    ...
    case Property::VECTOR2:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<Vector2>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property, &AnimatableProperty<Vector2>::Bake, value.Get<Vector2>() );
    ...
    case Property::VECTOR3:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<Vector3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property, &AnimatableProperty<Vector3>::Bake, value.Get<Vector3>() );
    ...
    case Property::VECTOR4:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<Vector4>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property, &AnimatableProperty<Vector4>::Bake, value.Get<Vector4>() );
    ...
    case Property::ROTATION:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<Quaternion>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property,&AnimatableProperty<Quaternion>::Bake,  value.Get<Quaternion>() );
    ...
    case Property::MATRIX:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<Matrix>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property,&AnimatableProperty<Matrix>::Bake,  value.Get<Matrix>() );
    ...
    case Property::MATRIX3:
    {
      ...
      // property is being used in a separate thread; queue a message to set the property
      SceneGraph::NodePropertyMessage<Matrix3>::Send( GetEventThreadServices().GetUpdateManager(), mNode, property,&AnimatableProperty<Matrix3>::Bake,  value.Get<Matrix3>() );
