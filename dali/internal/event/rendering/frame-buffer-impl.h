...
public:
   ...
   */
  static FrameBufferPtr New( unsigned int width, unsigned int height, int attachments );
...
private: // implementation
   ...
   * @param[in] attachments The attachments comprising the format of the FrameBuffer (bit-mask)
   */
  FrameBuffer( unsigned int width, unsigned int height, int attachments );
...
private: // data
  ...
  int mAttachments;                                    ///< Bit-mask of type FrameBuffer::Attachment::Mask
