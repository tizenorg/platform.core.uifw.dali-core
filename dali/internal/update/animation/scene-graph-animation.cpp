...
{
  return new ( gAnimationMemoryPool.AllocateRaw() ) Animation( durationSeconds, speedFactor, playRange, isLooping, endAction, disconnectAction );
}
...
{
  gAnimationMemoryPool.Free( static_cast<Animation*>( ptr ) );
}
