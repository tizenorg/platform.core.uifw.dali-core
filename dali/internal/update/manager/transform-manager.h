...
public:
  ...
  /**
   * Get the bounding sphere, in world coordinated, of a given component
   * @param[in] id Id of the transform component
   * @return The world space bounding sphere of the component
   */
  const Vector4& GetBoundingSphere( TransformId id );

  /**
   * Get the world matrix and size of a given component
   * @param[in] id Id of the transform component
   * @param[out] worldMatrix Local to world matrix of the component
   * @param[out] size size of the component
   */
  void GetWorldMatrixAndSize( TransformId id, Matrix& worldMatrix, Vector3& size );
