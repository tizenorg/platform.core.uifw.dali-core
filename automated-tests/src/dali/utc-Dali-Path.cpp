...
int UtcPathConstrainerApply(void)
{
  ...
  PathConstrainer.Apply( Property(actor, index), Property(actor,Dali::Actor::Property::POSITION), Vector2(0.0f,1.0f) );
...
int UtcPathConstrainerApplyRange(void)
{
  ...
  pathConstrainer.Apply( Property(actor,index), Property(actor,Dali::Actor::Property::POSITION),range );
