...
inline Internal::Adaptor::SingletonService& GetImplementation(Dali::SingletonService& service)
{
...
inline const Internal::Adaptor::SingletonService& GetImplementation(const Dali::SingletonService& service)
{
  DALI_ASSERT_ALWAYS( service && "SingletonService handle is empty" );
