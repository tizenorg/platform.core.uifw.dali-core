...
// These are the default sampling options
 ...
 * @param[in] bitshift Used to shift to the correct part of options.
 */
void RetrieveFilterMode( unsigned int options, int mask, int bitShift, FilterMode::Type& filterModeOut )
{
...
{
  return PackBitfield( DEFAULT_MINIFY, DEFAULT_MAGNIFY );
}
...
{
  FilterMode::Type filterMode = FilterMode::NONE;
