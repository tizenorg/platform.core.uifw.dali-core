...
{
  Internal::FrameBufferPtr frameBuffer = Internal::FrameBuffer::New();
...
void FrameBuffer::AttachColorTexture( Texture& texture )
{
  if( texture )
  {
    ...
    GetImplementation(*this).AttachColorTexture( texturePtr );
  }
}
...
void FrameBuffer::AttachDepthStencilTexture( Texture& texture )
{
  ...
  {
    Internal::NewTexturePtr texturePtr( &GetImplementation( texture ) );
    GetImplementation(*this).AttachDepthStencilTexture( texturePtr );
  }
}
