...
void ImageAttachment::SetImage( ImagePtr& image )
{
  ...
  if ( OnStage() )
  {
    ...
    SetTextureIdMessage( mEventThreadServices, *mSceneObject, resourceId );
  }
}
...
void ImageAttachment::SetPixelArea(const PixelArea& pixelArea)
{
  ...
  if( pixelArea != mPixelArea )
  {
    ...
    // sceneObject is being used in a separate thread; queue a message to set
    SetPixelAreaMessage( mEventThreadServices, *mSceneObject, mPixelArea );
  }
}
...
void ImageAttachment::ClearPixelArea()
{
  ...
  // sceneObject is being used in a separate thread; queue a message to set
  ClearPixelAreaMessage( mEventThreadServices, *mSceneObject );
}
...
void ImageAttachment::SetStyle(Style style)
{
  ...
  // sceneObject is being used in a separate thread; queue a message to set
  SetStyleMessage( mEventThreadServices, *mSceneObject, style );
}
...
void ImageAttachment::SetNinePatchBorder(const Vector4& border, bool inPixels)
{
  ...
  // sceneObject is being used in a separate thread; queue a message to set
  SetNinePatchBorderMessage( mEventThreadServices, *mSceneObject, border, inPixels );
}
...
void ImageAttachment::OnStageDisconnection2()
{
  ...
  SetTextureIdMessage( mEventThreadServices, *mSceneObject, 0u );
