...
void MeshAttachment::DoPrepareRender( BufferIndex updateBufferIndex )
{
  ...
  DALI_ASSERT_DEBUG(mesh->HasGeometry() && "mesh doesn't have geometry");
...
void MeshAttachment::DoGetScaleForSize( BufferIndex updateBufferIndex, const Vector3& nodeSize, Vector3& scaling )
{
  scaling = Vector3::ONE;
