...
enum Type
{
  OFF,  ///< Renderer does not read from the depth buffer @SINCE_1_1.37
  AUTO, ///< Renderer only reads from the depth buffer if in a 3D layer @SINCE_1_1.37
  ON    ///< Renderer reads from the depth buffer based on the DepthFunction @SINCE_1_1.37
};
