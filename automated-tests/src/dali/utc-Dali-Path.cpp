...
static void SetupPath( Dali::Path& path)
{
  ...
  path.GetControlPoint(0) = Vector3( 39.0,  90.0, 0.0);
  path.GetControlPoint(1) = Vector3( 56.0, 119.0, 0.0);

  //Control points for second segment
  path.GetControlPoint(2) = Vector3( 78.0, 120.0, 0.0);
  path.GetControlPoint(3) = Vector3( 93.0, 104.0, 0.0);
}
...
int utcDaliPathGetControlPoints(void)
{
  ...
  path.AddPoint(Vector3( 50.0,  50.0, 0.0));
  path.AddPoint(Vector3(120.0,  70.0, 0.0));
  path.GetControlPoint(0) = Vector3(0.0f, 0.0f, 0.0);
  path.GetControlPoint(1) = Vector3(108.0f, 57.0f, 0.0);
...
int utcDaliPathGetControlPoints01(void)
{
  ...
  path.AddPoint(Vector3( 50.0,  50.0, 0.0));
  path.AddPoint(Vector3(120.0,  70.0, 0.0));
  path.GetControlPoint(0) = Vector3(0.0f, 0.0f, 0.0); // Intangent for initial value is unused
  path.GetControlPoint(1) = Vector3(108.0f, 57.0f, 0.0);
