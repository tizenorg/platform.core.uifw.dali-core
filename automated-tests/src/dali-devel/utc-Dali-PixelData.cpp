...
int UtcDaliPixelData01(void)
{
  ...
  PixelDataPtr pixelData = new PixelData( buffer, width, height, Pixel::RGB888, PixelData::FREE );
...
int UtcDaliPixelData02(void)
{
  ...
  PixelDataPtr pixelData2 = new PixelData( buffer, width, height, Pixel::L8, PixelData::DELETE_ARRAY );
