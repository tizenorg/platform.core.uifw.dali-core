                    ...
                    SizeType yOffset )
{
  ...
  if( Fit( xOffset + bufferImage.GetWidth(),  yOffset + bufferImage.GetHeight() ) )
  {
    AllocateAtlas();
                    ...
                    SizeType yOffset)
{
  ...
  if( bitmap && Fit( xOffset + bitmap->GetImageWidth(), yOffset + bitmap->GetImageHeight()) )
  {
    AllocateAtlas();
    ResourceId destId = GetResourceId();
    if( destId )
...
bool Atlas::Fit( SizeType x, SizeType y )
{
  bool fit(false);
