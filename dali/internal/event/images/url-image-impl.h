...
const LoadPolicy IMAGE_LOAD_POLICY_DEFAULT = Dali::UrlImage::IMMEDIATE;

class UrlImage;
typedef IntrusivePtr<UrlImage> UrlImagePtr;
...
public:
   ...
   * @return a pointer to a newly created object.
   */
  static UrlImagePtr New( const std::string& url,
   ...
   */
  Dali::UrlImage::UrlImageSignal& LoadingFinishedSignal() { return mLoadingFinished; }
...
protected:
   ...
   */
  UrlImage( LoadPolicy loadPol = IMAGE_LOAD_POLICY_DEFAULT, ReleasePolicy releasePol = IMAGE_RELEASE_POLICY_DEFAULT );
...
private:
  ...
  Dali::UrlImage::UrlImageSignal mLoadingFinished;
