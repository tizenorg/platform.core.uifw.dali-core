...
private: // data
  ...
  std::vector<PropertyBufferPtr> mVertexBuffers; ///< Vector of connectors that hold the property buffers used by this geometry
  PropertyBufferPtr mIndexBuffer;            ///< Connector that holds the index buffer used by this geometry
