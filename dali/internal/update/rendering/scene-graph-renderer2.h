...
public:
  ...
  NewRenderer* GetRenderer()
  {
    ...
    {
      //Create renderer and add it to render manager
...
public: //Uniform map provider
  ...
  virtual bool GetUniformMapChanged( BufferIndex bufferIndex ) const{ return false;}
  virtual const CollectedUniformMap& GetUniformMap( BufferIndex bufferIndex ) const{ return mCollectedUniformMap[bufferIndex]; };
