...
public:
   ...
   * @param[in] diffuseTextureSampler The texture sampling parameters for the diffuse texture
   */
  void BindTextures( Program& program, unsigned int diffuseTextureSampler );
