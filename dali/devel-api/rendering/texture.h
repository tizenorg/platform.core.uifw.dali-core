...
{
  unsigned int layer;       ///< Specifies the layer in a cube map texture. 0 is GL_TEXTURE_CUBE_MAP_POSITIVE_X, 1 is GL_TEXTURE_CUBE_MAP_NEGATIVE_X
                            ///  2 is GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 3 is GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 3 is GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 4 is GL_TEXTURE_CUBE_MAP_NEGATIVE_Z
