...
public:
   ...
   */
  bool EmitTouchEventSignal( const TouchEvent& event, const Dali::TouchData& eventHandle );
   ...
   */
  Dali::Actor::TouchDataSignalType& TouchEventSignal();
...
protected:
  ...
  Dali::Actor::TouchDataSignalType         mTouchEventSignal;
