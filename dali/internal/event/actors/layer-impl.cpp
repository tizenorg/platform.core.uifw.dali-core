...
const int DEFAULT_LAYER_PROPERTY_COUNT = sizeof( DEFAULT_PROPERTY_DETAILS ) / sizeof( PropertyDetails );
...
Property::Index Layer::GetDefaultPropertyIndex(const std::string& name) const
{
  ...
  for( unsigned int i = 0; i < DEFAULT_LAYER_PROPERTY_COUNT; ++i )
  {
