...
std::size_t Geometry::AddVertexBuffer( PropertyBuffer& vertexBuffer )
{
  ...
  const SceneGraph::PropertyBuffer& sceneGraphPropertyBuffer = reinterpret_cast<const SceneGraph::PropertyBuffer&>( *vertexBuffer.GetSceneObject() );
...
{
  const SceneGraph::PropertyBuffer& sceneGraphPropertyBuffer = reinterpret_cast<const SceneGraph::PropertyBuffer&>( *(mVertexBufferConnectors[index].Get()->GetSceneObject()) );
