...
protected: // Constructors for deriving classes
   ...
   * @param copier Used to copy the owned object.
   */
  CallbackBase( void* object, MemberFunction function, Dispatcher dispatcher, Destructor destructor, ObjectCopier copier );
