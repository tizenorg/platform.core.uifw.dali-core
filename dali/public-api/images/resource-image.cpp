...
ResourceImage ResourceImage::New( const std::string& url, ImageDimensions size, ScalingMode scalingMode, SamplingMode samplingMode, bool orientationCorrection )
{
  Internal::ImageAttributes attributes = Internal::ImageAttributes::DEFAULT_ATTRIBUTES;
...
ResourceImage ResourceImage::New( const std::string& url, LoadPolicy loadPol, ReleasePolicy releasePol, ImageDimensions size, ScalingMode scalingMode, SamplingMode samplingMode, bool orientationCorrection )
{
  Internal::ImageAttributes attributes = Internal::ImageAttributes::DEFAULT_ATTRIBUTES;
  attributes.SetSize( Size( size.GetWidth(), size.GetHeight() ) );
  attributes.SetScalingMode( scalingMode );
