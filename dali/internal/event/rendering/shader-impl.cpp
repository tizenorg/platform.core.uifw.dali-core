...
Dali::Scripting::StringEnum ShaderHintsTable[] =
  { { "NONE",                     Dali::Shader::Hints::NONE},
    { "OUTPUT_IS_TRANSPARENT",    Dali::Shader::Hints::OUTPUT_IS_TRANSPARENT},
    { "MODIFIES_GEOMETRY",        Dali::Shader::Hints::MODIFIES_GEOMETRY}
  };
...
Property::Value HintString(const Dali::Shader::Hints::Value& hints)
{
  std::string s;

  if(hints == Dali::Shader::Hints::NONE)
  {
    s = "NONE";
  }

  if(hints & Dali::Shader::Hints::OUTPUT_IS_TRANSPARENT)
  {
    AppendString(s, "OUTPUT_IS_TRANSPARENT");
  }

  if(hints & Dali::Shader::Hints::MODIFIES_GEOMETRY)
  {
    ...
    case Dali::Shader::Property::PROGRAM:
    {
      if( propertyValue.GetType() == Property::MAP )
      {
        ...
        if( map )
        {
          std::string vertex;
          std::string fragment;
          Dali::Shader::Hints::Value hints(Dali::Shader::Hints::NONE);
          ...
          if( Property::Value* value = map->Find("hints") )
          {
            static_cast<void>( // ignore return
              Scripting::GetEnumeration< Dali::Shader::Hints::Value >(value->Get<std::string>().c_str(),
  ...
  Dali::Shader::Hints::Value hints )
{
  ...
  SetShaderProgramMessage( updateManager, *mSceneObject, mShaderData, (hints & Dali::Shader::Hints::MODIFIES_GEOMETRY) != 0x0 );
