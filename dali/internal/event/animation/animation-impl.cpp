...
: mUpdateManager( updateManager ),
  ...
  mIsLooping( false ),
  mPlayDirection( Dali::Animation::PlayDirectionForward ),
...
void Animation::CreateSceneObject()
{
  ...
  SceneGraph::Animation* animation = SceneGraph::Animation::New( mDurationSeconds, mIsLooping, mPlayDirection, mPlayRange, mEndAction, mDestroyAction );
...
void Animation::SetPlayDirection( PlayDirection direction)
{
  ...
  // mAnimation is being used in a separate thread; queue a message to set the value
  SetPlayDirectionMessage( mUpdateManager.GetEventToUpdate(), *mAnimation, direction );
}
...
{
  printf("Internal::SetPlayRange (%f,%f)", range.x, range.y );
