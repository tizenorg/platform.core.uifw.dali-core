...
const Vector2& TouchData::GetLocalPosition( unsigned int point ) const
{
  if( point < mPoints.size() )
  {
...
const Vector2& TouchData::GetScreenPosition( unsigned int point ) const
{
  if( point < mPoints.size() )
  {
...
const TouchPoint& TouchData::GetPoint( unsigned int point ) const
{
