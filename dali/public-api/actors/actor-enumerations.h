...
/**
 * EXPERIMENTAL_1_1.31 Clipping Modes not currently implemented.
...
enum Type
{
  CLIPPING_DISABLED,             ///< EXPERIMENTAL_1_1.31 Not currently implemented. @brief This actors renderers will not create a clipping stencil. Default. @SINCE_1_1.31
  CLIPPING_ENABLED,              ///< EXPERIMENTAL_1_1.31 Not currently implemented. @brief This actors renderers will create a clipping area that children will be clipped against. @SINCE_1_1.31
  CLIP_AND_RENDER,               ///< EXPERIMENTAL_1_1.31 Not currently implemented. @brief This actors renderers will create a clipping area that children will be clipped against. The renderers will also be rendered visually. @SINCE_1_1.31
};
}
