...
{
  Internal::TextArray utfCodes;
  utfCodes.push_back( character.GetImplementation().GetCharacter() );

  return Internal::Font::GetFamilyForText( utfCodes );
}
...
float Font::MeasureTextWidth(const Character& character, float textHeightPx) const
{
  ...
  return GetImplementation(*this).MeasureTextWidth( utfCodes, textHeightPx );
}
...
float Font::MeasureTextHeight(const Character& character, float textWidthPx) const
{
  ...
  return GetImplementation(*this).MeasureTextHeight( utfCodes, textWidthPx );
}
...
Vector3 Font::MeasureText(const Character& character) const
{
  ...
  return GetImplementation(*this).MeasureText( utfCodes );
}
...
bool Font::AllGlyphsSupported(const Character& character) const
{
  ...
  return GetImplementation(*this).AllGlyphsSupported( utfCodes );
}
