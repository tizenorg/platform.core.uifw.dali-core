...
private: // implementation
   ...
   */
  bool UpdateGpuBuffer( Context& context, BufferIndex bufferIndex );
...
private:
  ...
  Vector<GLuint> mAttributesLocation;                ///< Location of the attributes for the property buffer in this renderer.
