...
class TextureSet : public PropertyOwner, public UniformMap::Observer, public ConnectionChangePropagator::Observer
{
public:
...
inline void SetImageMessage( EventThreadServices& eventThreadServices, const TextureSet& imageArray, size_t index, ResourceId resourceId )
{
  ...
  new (slot) LocalType( &imageArray, &TextureSet::SetImage, index, resourceId );
}

inline void SetImageMessage( EventThreadServices& eventThreadServices, const TextureSet& imageArray, ResourceId resourceId)
{
  typedef MessageValue2< TextureSet, size_t, ResourceId > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &imageArray, &TextureSet::SetImage, 0, resourceId );
}

inline void SetSamplerMessage( EventThreadServices& eventThreadServices, const TextureSet& imageArray, size_t index, Render::Sampler* sampler )
{
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &imageArray, &TextureSet::SetSampler, index, sampler );
}
