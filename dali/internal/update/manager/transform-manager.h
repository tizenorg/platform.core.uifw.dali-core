...
private:
  ...
  Vector<unsigned int> mComponentDirty;    //1u if some of the parts of the component has changed in this frame, 0 otherwise
  Vector<unsigned int> mLocalMatrixDirty;  //1u if the local matrix has been updated in this frame, 0 otherwise
