...
void Core::Update( float elapsedSeconds, unsigned int lastVSyncTime, unsigned int nextVSyncTime, UpdateStatus& status )
{
  mImpl->Update( elapsedSeconds, lastVSyncTime, nextVSyncTime, status );
}
