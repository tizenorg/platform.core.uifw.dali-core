...
enum Type
{
  ...
  AUTO,      ///< Managed by the Actor clipping API. Default @SINCE_1_1.37
  ON         ///< On for this renderer. Select this to use the Renderer stencil properties to manage behavior. Note that Actor clipping management is bypassed for this renderer @SINCE_1_1.37
};
