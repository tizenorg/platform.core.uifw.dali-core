...
void Renderer::SetTextureSet( TextureSet& textureSet )
{
  DALI_ASSERT_ALWAYS( textureSet && "TextureSet handle not initialized" );
  GetImplementation(*this).SetTextureSet( GetImplementation(textureSet) );
}

TextureSet Renderer::GetTextureSet() const
{
  Internal::TextureSet* textureSet( GetImplementation(*this).GetTextureSet() );
