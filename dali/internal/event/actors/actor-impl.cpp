...
static float GetDimensionValue( const Vector2& values, Dimension dimension )
{
  switch( dimension )
  {
    case WIDTH:
...
static float GetDimensionValue( const Vector3& values, Dimension dimension )
{
...
{
  return IsLayoutNegotiated( dimension ) ? GetNegotiatedDimension( dimension ) : GetDimensionValue( GetSize(), dimension );
}
