...
FixedSizeMemoryPoolObjectPtr FixedSizeMemoryPoolObject::New( SizeType size )
{
  return FixedSizeMemoryPoolObjectPtr( new FixedSizeMemoryPoolObject( size ) );
}

FixedSizeMemoryPoolObjectPtr FixedSizeMemoryPoolObject::New( SizeType size, SizeType initialCapacity, SizeType maximumBlockCapacity )
{
  return FixedSizeMemoryPoolObjectPtr( new FixedSizeMemoryPoolObject( size, initialCapacity, maximumBlockCapacity ) );
}

FixedSizeMemoryPoolObject::FixedSizeMemoryPoolObject( SizeType size )
{
  mPool = new FixedSizeMemoryPool( size );
}

FixedSizeMemoryPoolObject::FixedSizeMemoryPoolObject( SizeType size, SizeType initialCapacity, SizeType maximumBlockCapacity )
{
  mPool = new FixedSizeMemoryPool( size, initialCapacity, maximumBlockCapacity );
}

FixedSizeMemoryPoolObject::~FixedSizeMemoryPoolObject()
{
  delete mPool;
}

FixedSizeMemoryPool* FixedSizeMemoryPoolObject::GetPool()
{
  return mPool;
}
