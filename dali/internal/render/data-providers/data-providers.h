#ifndef __DALI_INTERNAL_SCENE_GRAPH_DATA_PROVIDERS_H__
#define __DALI_INTERNAL_SCENE_GRAPH_DATA_PROVIDERS_H__
/*
...
/**
 * Wraps all the data provider pointers for the renderer. This allows the
 ...
 * provider pointers through the message system. It does not take ownership
 * of any objects.
 *
...
public:
   ...
   */
  void SetSamplers( const DataProviders::Samplers& samplers );

  /**
   * Returns the list of sampler data providers
   * @return The list of samplers
   */
  const DataProviders::Samplers& GetSamplers() const;
