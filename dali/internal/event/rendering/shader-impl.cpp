...
Dali::Scripting::StringEnum ShaderHintsTable[] =
  { { "HINT_NONE",                     Dali::Shader::ShaderHints::HINT_NONE},
    { "HINT_REQUIRES_SELF_DEPTH_TEST", Dali::Shader::ShaderHints::HINT_REQUIRES_SELF_DEPTH_TEST},
    { "HINT_OUTPUT_IS_TRANSPARENT",    Dali::Shader::ShaderHints::HINT_OUTPUT_IS_TRANSPARENT},
    { "HINT_OUTPUT_IS_OPAQUE",         Dali::Shader::ShaderHints::HINT_OUTPUT_IS_OPAQUE},
    { "HINT_MODIFIES_GEOMETRY",        Dali::Shader::ShaderHints::HINT_MODIFIES_GEOMETRY}
  };
                                 ...
                                 const Property::Value& propertyValue )
{
  switch(index)
  {
    ...
    {
      DALI_ASSERT_ALWAYS(propertyValue.GetType() == Property::Type::MAP);
