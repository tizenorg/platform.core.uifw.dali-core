...
bool AttributesEqual( ImageDimensions aDims, ScalingMode aScaling, SamplingMode aSampling, bool aOrient, ImageDimensions bDims, ScalingMode bScaling, SamplingMode bSampling, bool bOrient )
{
  return aDims     == bDims &&
         aScaling  == bScaling &&
         aSampling == bSampling &&
...
bool AttributesLessAssumingNotEqual( ImageDimensions aDims, ScalingMode aScaling, SamplingMode aSampling, bool aOrient, ImageDimensions bDims, ScalingMode bScaling, SamplingMode bSampling, bool bOrient )
{
  return aDims     < bDims &&
         aScaling  < bScaling &&
         aSampling < bSampling &&
