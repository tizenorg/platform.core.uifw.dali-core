...
public:
   ...
   */
  ActiveConstraintBase( EventToUpdate& messageController, Property::Index targetPropertyIndex, SourceContainer& sources );
   ...
   */
  void OnFirstApply( ProxyObject& parent, TimePeriod applyTime );
