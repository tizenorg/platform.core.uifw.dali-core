 ...
 * the ResourceImage is created with ON_DEMAND loading policy or a compatible resource is found in cache.
...
public:
   ...
   */
  typedef SignalV2< void (ResourceImage) > ResourceImageSignal;
