  ...
  mProcessingEvent(false)
{
  ...
  mRenderManager->GetRenderQueue().SetSceneGraphBuffers( mUpdateManager->GetSceneGraphBuffers() );
...
void Core::Render( RenderStatus& status )
{
  ...
  mUpdateManager->GetSceneGraphBuffers().SanityCheck();
  bool updateRequired = mRenderManager->Render( status, mUpdateManager->GetSceneGraphBuffers() );
