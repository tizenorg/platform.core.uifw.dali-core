...
enum PropertyRanges
{
  ...
  PROPERTY_CUSTOM_MAX_INDEX                     = 59999999,   ///< The maximum index supported for custom properties @SINCE_1_1.44

  CORE_PROPERTY_MAX_INDEX                       = 60000000,   ///< The maximum index that Core properties can go up to @SINCE_1_1.44
};
