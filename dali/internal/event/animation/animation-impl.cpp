...
const Dali::Animation::EndAction DEFAULT_DISCONNECTED_ACTION( Dali::Animation::BakeFinal );
...
AnimationPtr Animation::New(float durationSeconds)
{
  ...
  AnimationPtr animation = new Animation( updateManager, playlist, durationSeconds, DEFAULT_END_ACTION, DEFAULT_DISCONNECTED_ACTION, Dali::AlphaFunctions::Linear );
