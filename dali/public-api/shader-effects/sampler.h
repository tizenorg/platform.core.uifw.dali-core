...
public:
  ...
  /// @name Properties
  /** @{ */
  static const Property::Index MINIFICATION_FILTER;   ///< name "minification-filter",  type STRING
  static const Property::Index MAGNIGICATION_FILTER;  ///< name "magnification-filter", type STRING
  static const Property::Index U_WRAP;                ///< name "u-wrap",               type STRING
  static const Property::Index V_WRAP;                ///< name "v-wrap",               type STRING
  static const Property::Index AFFECTS_TRANSPARENCY;  ///< name "affects-transparency", type BOOLEAN
  /** @} */
