...
public:
   ...
   *
   * @SINCE_1_0.0
   * @param[i] rhs Const reference to an IntrusivePtr
 ...
 *
 * @SINCE_1_0.0
 * @param[i] lhs Intrusive pointer to compare with
 * @param[i] rhs Intrusive pointer to compare against
 ...
 * @SINCE_1_0.0
 * @param[i] lhs Intrusive pointer to compare with
 * @param[i] rhs Object to compare against
 ...
 *
 * @SINCE_1_0.0
 * @param[i] lhs Object to compare with
 * @param[i] rhs Intrusive pointer to compare against
 * @return True if the intrusive pointer points at the specified object
 */
template<typename T, typename U>
