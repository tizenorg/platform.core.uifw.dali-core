...
public:
   ...
   *
   * @note None and Box modes do not guarantee that the loaded pixel array
   * exactly matches the rectangle specified by the desired dimensions and
   * ScalingMode, but all other filter modes do.
   */
  enum FilterMode
  {
    None,           ///< No filtering is performed. If the ScaleToFill scaling mode is enabled, the borders of the
