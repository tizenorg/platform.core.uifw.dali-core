...
namespace FittingMode
{
  enum Type
  {
    ShrinkToFit, ///< Fit full image inside desired width & height, potentially not
                 ///  filling one of either the desired image width or height with
                 ///  pixels.
    ScaleToFill, ///< Image fills whole desired width & height with image data. The
    ...
    FitWidth,    ///< Image fills whole width. Height is scaled proportionately to
                 ///  maintain aspect ratio.
    FitHeight    ///< Image fills whole height. Width is scaled proportionately to
                 ///  maintain aspect ratio.
  };
  inline Type Default() { return ShrinkToFit; }
}
