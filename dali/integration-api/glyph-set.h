...
#include <dali/integration-api/image-data.h> ///! [ImageData]
...
{
public:
  typedef std::pair<ImageDataPtr, GlyphMetrics>  Character; /// typedef std::pair<BitmapPtr, GlyphMetrics>  Character; ///! [ImageData]
   ...
   */
  void AddCharacter(ImageDataPtr imageData, const GlyphMetrics& glyphMetrics);/// void AddCharacter(BitmapPtr bitmapData, const GlyphMetrics& glyphMetrics); ///! [ImageData]
