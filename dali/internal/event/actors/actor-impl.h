...
public:  // For Animation
   ...
   */
  void NotifySizeAnimation(Dali::Internal::Animation& animation, const Vector3& targetSize);

  /**
   * For use in derived classes.
   * This should only be called by Animation, when the actor is resized using Animation::Resize().
   */
  virtual void OnSizeAnimation(Dali::Internal::Animation& animation, const Vector3& targetSize) {}
