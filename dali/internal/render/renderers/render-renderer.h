...
public:
   ...
   */
  static NewRenderer* New( NodeDataProvider& nodeDataProvider, DataProviders* dataProviders );
  /**
   * Constructor.
   * @param[in] nodeDataProvider The node data provider
   * @param[in] dataProviders The data providers for the renderer
   */
  NewRenderer( NodeDataProvider& nodeDataProvider, DataProviders* dataProviders );
...
public: //@todo MESH_REWORK make private after merge with SceneGraph::Renderer
  OwnerPointer< DataProviders > mDataProviders;
