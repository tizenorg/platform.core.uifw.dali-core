...
FrameBuffer::FrameBuffer( unsigned int width, unsigned int height, int attachments )
:mId( 0u ),
 mDepthBuffer( ( attachments & Dali::FrameBuffer::Attachment::DEPTH ) ? 1u : 0u ),
 mStencilBuffer( ( attachments & Dali::FrameBuffer::Attachment::STENCIL ) ? 1u : 0u ),
 mWidth( width ),
 mHeight( height )
{
}
