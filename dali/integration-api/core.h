...
public:
   ...
   * @param[in] nextVSyncTime The time of the next predicted VSync in milliseconds
   ...
   */
  void Update( float elapsedSeconds, unsigned int lastVSyncTime, unsigned int nextVSyncTime, UpdateStatus& status );
