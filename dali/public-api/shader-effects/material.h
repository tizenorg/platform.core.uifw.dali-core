...
public:
  ...
  static const Property::Index FACE_CULLING_MODE;           ///< name "face-culling-mode",              type STRING
  static const Property::Index BLENDING_MODE;               ///< name "blending-mode",                  type STRING
  static const Property::Index BLEND_EQUATION;              ///< name "blend-equation",                 type STRING
  static const Property::Index BLENDING_SRC_FACTOR_RGB;     ///< name "source-blend-factor-rgb",        type STRING
  static const Property::Index BLENDING_DEST_FACTOR_RGB;    ///< name "destination-blend-factor-rgb",   type STRING
  static const Property::Index BLENDING_SRC_FACTOR_ALPHA;   ///< name "source-blend-factor-alpha",      type STRING
  static const Property::Index BLENDING_DEST_FACTOR_ALPHA;  ///< name "destination-blend-factor-alpha", type STRING
  static const Property::Index BLEND_COLOR;                 ///< name "blend-color",                    type VECTOR4
  /** @} */
