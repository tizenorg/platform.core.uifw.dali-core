...
{
  if( mImpl->type == VECTOR2 && mImpl->vector2Value )
  {
...
{
  if( mImpl->type == VECTOR3 && mImpl->vector3Value )
  {
...
{
  if( mImpl->type == VECTOR4 && mImpl->vector4Value )
  {
...
{
  if( mImpl->type == MATRIX3 && mImpl->matrix3Value )
  {
...
{
  if( mImpl->type == MATRIX && mImpl->matrixValue )
  {
...
{
  if( mImpl->type == RECTANGLE && mImpl->rectValue )
  {
...
{
  if( mImpl->type == ROTATION && mImpl->quaternionValue )
  {
...
{
  if( mImpl->type == STRING && mImpl->stringValue )
  {
...
{
  if( mImpl->type == ARRAY && mImpl->arrayValue )
  {
...
{
  if( mImpl->type == MAP && mImpl->mapValue )
  {
