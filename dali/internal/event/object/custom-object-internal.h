...
protected:
  ...
  Update::CustomPropertyOwner* mUpdateObject;
};
...
inline Internal::CustomObject& GetImpl( Dali::CustomObject& obj )
{
  DALI_ASSERT_ALWAYS( obj && "CustomObject handle is empty" );
...
inline const Internal::CustomObject& GetImpl( const Dali::CustomObject& obj )
{
  DALI_ASSERT_ALWAYS( obj && "CustomObject handle is empty" );
