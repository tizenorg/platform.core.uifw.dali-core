...
struct RenderManager::Impl
{
  ...
  ShaderDispatcher*                   shaderSaveDispatcher;     ///< Interface for compiled shader binaries to be sent back to for caching and saving.
...
void RenderManager::SetShaderSaver( ShaderDispatcher& upstream )
{
