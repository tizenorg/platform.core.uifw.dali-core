...
enum PropertyRanges
{
  DEFAULT_DERIVED_HANDLE_PROPERTY_START_INDEX   = 0,          ///< For all objects deriving from Handle (including Actors).

  DEFAULT_ACTOR_PROPERTY_START_INDEX            = DEFAULT_DERIVED_HANDLE_PROPERTY_START_INDEX, ///< Start index for Actor.
