...
int UtcDaliPanGestureAngleHandling(void)
{
  ...
  DALI_TEST_EQUALS( detector.GetAngleCount(), static_cast<AngleSizeType>(1), TEST_LOCATION );
  bool found = false;
  ...
  DALI_TEST_EQUALS( detector.GetAngleCount(), static_cast<AngleSizeType>(2), TEST_LOCATION );
  ...
  DALI_TEST_EQUALS( detector.GetAngleCount(), static_cast<AngleSizeType>(0), TEST_LOCATION );
  END_TEST;
}
