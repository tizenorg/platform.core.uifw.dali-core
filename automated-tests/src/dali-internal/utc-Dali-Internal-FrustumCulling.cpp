...
Actor CreateMeshActorToStage( TestApplication& application, Vector3 parentOrigin = ParentOrigin::CENTER, Vector3 anchorPoint = AnchorPoint::CENTER, Shader::Hints::Value shaderHints = Shader::Hints::NONE )
{
...
int UtcFrustumCullDisabledP(void)
{
  ...
  CreateMeshActorToStage( application, Vector3( 7.0f, 0.5f, 0.5f ), AnchorPoint::CENTER, Shader::Hints::MODIFIES_GEOMETRY );
