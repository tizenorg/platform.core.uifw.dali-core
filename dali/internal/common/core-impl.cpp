...
void Core::Update( float elapsedSeconds, unsigned int lastVSyncTime, unsigned int nextVSyncTime, Integration::UpdateStatus& status )
{
  ...
  status.keepUpdating = mUpdateManager->Update( elapsedSeconds, lastVSyncTime, nextVSyncTime );
