...
public:
  ...
  enum FilterMode
  {
    DontCare,       ///< For when the client strongly prefers a cache-hit. Defaults to BoxThenNearest.
    Trim,           ///< Cut away the top/bottom or left/right borders of the image to match the aspect ratio of desired
                    ///  dimensions without downscaling.
    ...
    BoxThenTrim,    ///< Iteratively box filter to generate an image of 1/2, 1/4, 1/8, ... width and height and
                    ///  approximately the desired size, then cut away the top/bottom or left/right borders of the image
                    ///  to match the aspect ratio of desired dimensions.
