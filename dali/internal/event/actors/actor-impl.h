...
typedef std::vector<Dali::Actor> ActorContainer; // Store handles
...
public:
  ...
  /**
   * @brief Retrieve a reference to Actor's children.
   * @note caller must check  actor.GetChildCount() > 0 before calling (mChildren can be null)
