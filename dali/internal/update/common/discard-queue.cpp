...
void DiscardQueue::Add( BufferIndex updateBufferIndex, Node* node )
{
  ...
  {
    mGeometryBatcher->DiscardBatch( node, updateBufferIndex );
  }
  else if( node->GetBatchParent() )
  {
    mGeometryBatcher->DiscardBatch( node->GetBatchParent(), updateBufferIndex );
  }
...
void DiscardQueue::Clear( BufferIndex updateBufferIndex )
{
  ...
  mGeometryBatcher->DiscardDeadBatches( updateBufferIndex );
