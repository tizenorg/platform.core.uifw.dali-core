...
public:
   ...
   * @pre nativeImageInterface should be initialised
   * @param [in] @param [in] resourceData An reference to the object of the interface implementation.
    * @return a pointer to a newly created object.
   */
  static NativeImagePtr New( NativeImageInterface& resourceData );
