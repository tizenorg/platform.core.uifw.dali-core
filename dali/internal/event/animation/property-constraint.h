...
public:
   ...
   */
  virtual PropertyConstraint< PropertyType >* Clone()
  {
   ...
   */
  virtual PropertyConstraint< PropertyType >* CloneComponentFunc()
  {
    return new PropertyConstraint< PropertyType >( mFunction );
  }
