...
public:
   ...
   * @return The index of the texture in the array of textures
   */
  size_t AddTexture( Image image, const std::string& uniformName, Sampler sampler = Sampler() );
   ...
   *
   * @param[in] index The index of the texture in the array of textures
   * @param[in] The new uniform name
   */

  void SetTextureUniformName( size_t index, std::string& uniformName );

  /**
   * @brief Establish if a given texture will affect the transparency of the object ( true by default )
   *
   * @param[in] index The index of the texture in the array of textures
